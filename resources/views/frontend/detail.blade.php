                                    ...
                                    <div class="wpsm-two-third tabletblockdisplay wpsm-column-last mb30">
                                        ...
                                        <div class="rh_post_layout_rev_price_holder position-relative">
                                            ...
                                            <div class="compare-button-holder">
                                                ...
                                                <p class="price">
                                                    <del><span class="woocommerce-Price-amount amount"><bdi>{{$itemDetail[0]->price_old}}<span
                                                                    class="woocommerce-Price-currencySymbol">&#8363;</span></bdi></span>
                                                    </del>
                                                    <ins><span class="woocommerce-Price-amount amount"><bdi>{{$itemDetail[0]->price}}<span
                                                                    class="woocommerce-Price-currencySymbol">&#8363;</span></bdi></span>
                                                    </ins>
                                                </p>
                                                <div class="woo-button-area mb30">
                                                    ...
                                                    <form class="cart"
                                                        ...
                                                        <button type="submit" name="add-to-cart" value="20521"
                                                         class="btn btn-success">Thêm vào giỏ hàng
                                                        </button>

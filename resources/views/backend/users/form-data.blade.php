                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="my-5 step" data-wizard-type="step-content">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3 col-xl-3">
                                            <input class="form-control form-control-solid form-control-lg" id="firstname"
                                                   name="firstname" type="text" value="{{@$user->firstname}}" onkeyup="setFullName()">
                                        ...
                                        <div class="col-lg-3 col-xl-3">
                                            <input class="form-control form-control-solid form-control-lg" id="lastname"
                                                   name="lastname" type="text" value="{{@$user->lastname}}"  onkeyup="setFullName()">
                                            <div class="fv-plugins-message-container"></div>
                                        </div>
                                        <label
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <input class="form-control form-control-solid form-control-lg"
                                                   name="birtday" type="date" value="{{@$user->birtday}}">
                                            <div class="fv-plugins-message-container"></div>
                                        </div>
                                    </div>
                                    <!--end::Group-->

            ...
            <div class="login-form text-center text-white p-7 position-relative overflow-hidden">
                ...
                <form method="post" action="{{route('register')}}">
                    ...
                    <div class="form-group">
                        <input class="form-control h-auto text-white placeholder-white opacity-70 bg-dark-o-70 rounded-pill border-0 py-4 px-8" type="text" placeholder="Fullname" name="name" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input class="form-control h-auto text-white placeholder-white opacity-70 bg-dark-o-70 rounded-pill border-0 py-4 px-8" type="password" placeholder="Confirm Password" name="password_confirmation" />
                    </div>
                    ...
                    <div class="form-group">
                        <button class="btn btn-pill btn-outline-white font-weight-bold opacity-90 px-15 py-3 m-2" type="submit">Sign Up</button>
                        <button type="button" class="btn btn-pill btn-outline-white font-weight-bold opacity-70 px-15 py-3 m-2">Cancel</button>
                    </div>
                </form>
            </div>

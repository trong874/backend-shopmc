jQuery(function (t) {
    ...
    "hidden" === Cookies.get(e) ? t(".woocommerce-store-notice").hide() : t(".woocommerce-store-notice").show(), t(".woocommerce-store-notice__dismiss-link").click(function (o) {
        Cookies.set(e, "hidden", {path: "/"}), t(".woocommerce-store-notice").hide(), o.preventDefault()
        ...
        var o = t(this).parent(), e = o.find("span.description");
        ...
        o.length && t("html, body").animate({scrollTop: o.offset().top - 100}, 1e3)

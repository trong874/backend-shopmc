...
!function (t) {
    ...
    s = function (t) {
        "use strict";
        var e = "left", n = "right", r = "up", i = "down", u = "none", s = "doubletap", a = "longtap", o = "horizontal",
            l = "vertical", h = "all", f = "move", D = "end", p = "cancel", c = "ontouchstart" in window,
            d = window.navigator.msPointerEnabled && !window.PointerEvent && !c,
            g = (window.PointerEvent || window.navigator.msPointerEnabled) && !c, _ = "TouchSwipe";
        ...
        function m(m, v) {
            ...
            var y = c || g || !v.fallbackToMouseEvents,
                ...
                E = g ? d ? "MSPointerCancel" : "pointercancel" : "touchcancel", b = 0, T = null, A = null, M = 0,
                P = 0, B = 0, S = 1, O = 0, k = 0, L = null, N = t(m), R = "start", I = 0, z = {}, Y = 0, j = 0, X = 0,
                V = 0, U = 0, W = null, q = null;
            try {
                N.on(C, H), N.on(E, K)
            } catch (m) {
            ...
            function G(s) {
                ...
                if (R !== D && R !== p && !dt()) {
                    var c, d, g, _, m, y, C, x = a.touches, F = mt(x ? x[0] : a);
            ...
            function Q(t) {
                var e, n = t.originalEvent ? t.originalEvent : t, r = n.touches;
                if (r) {
            ...
            function ut() {
                var t = lt(), e = ht(), n = null === v.pinchThreshold || O >= v.pinchThreshold;
                return t && e && n
            }
            ...
            function mt(t) {
                var e = void 0 !== t.identifier ? t.identifier : 0, n = z[e] || null;
            ...
            this.enable = function () {
                ...
                if ("object" == typeof e) v = t.extend(v, e); else if (void 0 !== v[e]) {
        ...
        t.fn.rsswipe = function (e) {
            var n = t(this), r = n.data(_);
            if (r && "string" == typeof e) {
                if (r[e]) return r[e].apply(r, Array.prototype.slice.call(arguments, 1));
                t.error("Method " + e + " does not exist on jQuery.rsswipe")
            } else if (r && "object" == typeof e) r.option.apply(r, arguments); else if (!(r || "object" != typeof e && e)) return function (e) {
            ...
            VERTICAL: l,
            AUTO: "auto"
        }, t.fn.rsswipe.fingers = {ONE: 1, TWO: 2, THREE: 3, FOUR: 4, FIVE: 5, ALL: h}
    ...
    var n;
    (n = jQuery).waitForImages = {hasImageProperties: ["backgroundImage", "listStyleImage", "borderImage", "borderCornerImage"]}, n.expr[":"].uncached = function (t) {
        ...
        return this.each((function () {
            var i = n(this), u = [];
            if (r) {
                var s = n.waitForImages.hasImageProperties || [], a = /url\((['"]?)(.*?)\1\)/g;
                i.find("*").each((function () {
                    var t = n(this);
                    t.is("img:uncached") && u.push({src: t.attr("src"), element: t[0]}), n.each(s, (function (e, n) {
                        var r, i = t.css(n);
                        if (!i) return !0;
                        for (; r = a.exec(i);) u.push({src: r[2], element: t[0]})
                    }))
                }))
    ...
    */
    n.r(e);
    var u, s, a, o, l, h, f, D, p, c, d, g, _, m, v, y, C, x, F, w, E, b, T, A, M,
        P = {autoSleep: 120, force3D: "auto", nullTargetWarn: 1, units: {lineHeight: ""}},
        B = {duration: .5, overwrite: !1, delay: 0}, S = 1e8, O = 2 * Math.PI, k = O / 4, L = 0, N = Math.sqrt,
        R = Math.cos, I = Math.sin, z = function (t) {
            ...
            return Y(t) || z(t)
        }, H = Array.isArray, G = /(?:-?\.?\d|\.)+/gi, Q = /[-+=.]*\d+[.e\-+]*\d*[e\-\+]*\d*/g,
        K = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, Z = /[-+=.]*\d+(?:\.|e-|e)*\d*/gi, $ = /\(([^()]+)\)/i, J = /[+-]=-?[\.\d]+/,
        tt = /[#\-+.]*\b[a-z\d-=+%.]+/gi, et = {}, nt = {}, rt = function (t) {
            ...
            return 0
        }, ot = {}, lt = [], ht = {}, ft = {}, Dt = {}, pt = 30, ct = [], dt = "", gt = function (t) {
            var e, n, r = t[0];
            ...
            var r, i = j(t[1]), u = (i ? 2 : 1) + (e < 2 ? 0 : 1), s = t[u];
            ...
            var e = t.parent || u, n = t.keyframes ? At : Tt;
            if (U(t.inherit)) for (; e;) n(t, e.vars.defaults), e = e.parent;
            return t
        }, Ot = function (t, e, n, r) {
            void 0 === n && (n = "_first"), void 0 === r && (r = "_last");
            var i = e._prev, u = e._next;
            ...
            return e.parent && kt(e), e._start = yt(n + e._delay), e._end = yt(e._start + (e.totalDuration() / Math.abs(e.timeScale()) || 0)), function (t, e, n, r, i) {
                void 0 === n && (n = "_first"), void 0 === r && (r = "_last");
                var u, s = t[r];
        ...
        }, qt = {_start: 0, endTime: at}, Ht = function t(e, n) {
            var r, i, u = e.labels, s = e._recent || qt, a = e.duration() >= S ? s.endTime(!1) : e._dur;
            ...
            if (Y(t)) return t;
            var e = V(t) ? t : {each: t}, n = Ae(e.ease), r = e.from || 0, i = parseFloat(e.base) || 0, u = {},
                s = r > 0 && r < 1, a = isNaN(r) || s, o = e.axis, l = r, h = r;
            return z(r) ? l = h = {
                center: .5,
                edges: .5,
                end: 1
            }[r] || 0 : !s && a && (l = r[0], h = r[1]), function (t, s, f) {
                var D, p, c, d, g, _, m, v, y, C = (f || e).length, x = u[C];
                if (!x) {
            ...
            var e = (t = !t.name && t.default || t).name, n = Y(t), r = e && !n && t.init ? function () {
                    this._props = []
                } : t, i = {init: at, render: Je, add: Ie, kill: en, modifier: tn, rawVars: 0},
                u = {targetTest: 0, get: 0, getSetter: Qe, aliases: {}, register: 0};
            if (xe(), t !== r) {
                if (ft[e]) return;
            ...
            if (!p) {
                if ("," === t.substr(-1) && (t = t.substr(0, t.length - 1)), pe[t]) p = pe[t]; else if ("#" === t.charAt(0)) 4 === t.length && (r = t.charAt(1), i = t.charAt(2), u = t.charAt(3), t = "#" + r + r + i + i + u + u), p = [(t = parseInt(t.substr(1), 16)) >> 16, t >> 8 & 255, 255 & t]; else if ("hsl" === t.substr(0, 3)) if (p = D = t.match(G), e) {
                    if (~t.indexOf("=")) return p = t.match(Q), n && p.length < 4 && (p[3] = 1), p
                } else s = +p[0] % 360 / 360, a = +p[1] / 100, r = 2 * (o = +p[2] / 100) - (i = o <= .5 ? o * (a + 1) : o + a - o * a), p.length > 3 && (p[3] *= 1), p[0] = ce(s + 1 / 3, r, i), p[1] = ce(s, r, i), p[2] = ce(s - 1 / 3, r, i); else p = t.match(G) || pe.transparent;
                p = p.map(Number)
            }
            ...
            var r, i, u, s, a = "", o = (t + a).match(me), l = e ? "hsla(" : "rgba(", h = 0;
            if (!o) return t;
            if (o = o.map((function (t) {
                return (t = de(t, e, 1)) && l + (e ? t[0] + "," + t[1] + "%," + t[2] + "%," + t[3] : t.join(",")) + ")"
            })), n && (u = ge(t), (r = n.c).join(a) !== u.c.join(a))) for (s = (i = t.replace(me, "1").split(K)).length - 1; h < s; h++) a += i[h] + (~r.indexOf(h) ? o.shift() || l + "0,0,0,0)" : (u.length ? u : o.length ? o : n).shift());
            if (!i) for (s = (i = t.split(me)).length - 1; h < s; h++) a += i[h] + o[h];
            return a + i[s]
        }, me = function () {
            var t, e = "(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3}){1,2}\\b";
            for (t in pe) e += "|" + t + "\\b";
            return new RegExp(e + ")", "gi")
        }(), ve = /hsl[a]?\(/, ye = function (t) {
            var e, n = t.join(" ");
            ...
            return !D && Ce.wake()
        }, Fe = {}, we = /^[\d.\-M][\d.\-,\s]/, Ee = /["']/g, be = function (t) {
            ...
            var i, u = {easeIn: e, easeOut: n, easeInOut: r};
            ...
            var i = n >= 1 ? n : 1, u = (r || (e ? .3 : .45)) / (n < 1 ? n : 1), s = u / O * (Math.asin(1 / i) || 0),
                a = function (t) {
    ...
    var Le = function (t) {
        ...
        return n.to = function (t, e, n) {
            ...
            var r, i, s, a, o, l, h, f, D, p, c, d, g = this._time, _ = this._dirty ? this.totalDuration() : this._tDur,
                m = this._dur, v = this !== u && t > _ - 1e-8 && t >= 0 ? _ : t < 1e-8 ? 0 : t,
            ...
            if (v !== this._tTime || n || y) {
                ...
                }(this, yt(g), yt(r))) && (v -= r - (r = h._start)), this._tTime = v, this._time = r, this._act = !f, this._initted || (this._onUpdate = this.vars.onUpdate, this._initted = 1, this._zTime = t), g || !r || e || he(this, "onStart"), r >= g && t >= 0) for (i = this._first; i;) {
            ...
            e = e || {};
            var n = this, r = Ht(n, t), i = e, u = i.startAt, s = i.onStart, a = i.onStartParams, o = Ue.to(n, Tt(e, {
                ease: "none",
                lazy: !1,
                time: r,
            ...
            return this.tweenTo(e, Tt({startAt: {time: Ht(this, t)}}, n))
        }, n.recent = function () {
            return this._recent
            ...
            var e, n, r, i, s = 0, a = this, o = a._last, l = S;
    ...
    var Ne, Re = function (t, e, n, r, i, u, s) {
            var a, o, l, h, f, D, p, c, d = new un(this._pt, t, e, 0, 1, $e, null, i), g = 0, _ = 0;
            ...
            if (ft[t] && !1 !== (s = new ft[t]).init(i, s.rawVars ? e[t] : function (t, e, n, r, i) {
                ...
                return s
            }(e[t], r, i, u, n), n, r, u) && (n._pt = a = new un(n._pt, i, t, 0, 1, s.render, s, 0, s.priority), n !== f)) for (o = n._ptLookup[n._targets.indexOf(i)], l = s._props.length; l--;) o[s._props[l]] = a;
            return s
        }, Ye = function t(e, n) {
            var r, i, s, a, o, l, h, f, D, p, c, d, g = e.vars, _ = g.ease, m = g.startAt, v = g.immediateRender,
                y = g.lazy, C = g.onUpdate, x = g.onUpdateParams, F = g.callbackScope, w = g.runBackwards, E = g.yoyoEase,
                b = g.keyframes, T = g.autoRevert, A = e._dur, M = e._startAt, P = e._targets, S = e.parent,
                O = S && "nested" === S.data ? S.parent._targets : P, k = "auto" === e._overwrite, L = e.timeline;
            if (!L || b && _ || (_ = "none"), e._ease = Ae(_, B.ease), e._yEase = E ? Te(Ae(!0 === E ? _ : E, B.ease)) : 0, E && e._yoyo && !e._repeat && (E = e._yEase, e._yEase = e._ease, e._ease = E), !L) {
                if (M && M.render(-1, !0).kill(), m) {
                    if (kt(e._startAt = Ue.set(P, Tt({
                        ...
                        callbackScope: F,
                        stagger: 0
                    }, m))), v) if (n > 0) !T && (e._startAt = 0); else if (A) return
                } else if (w && A) if (M) !T && (e._startAt = 0); else if (n && (v = !1), kt(e._startAt = Ue.set(P, Mt(Bt(g, ot), {
                    overwrite: !1,
                    data: "isFromStart",
                    lazy: v && U(y),
                    immediateRender: v,
                ...
                for (r = Bt(g, ot), e._pt = 0, d = (f = P[0] ? _t(P[0]).harness : 0) && g[f.prop], y = A && U(y) || y && !A, i = 0; i < P.length; i++) {
                    if (h = (o = P[i])._gsap || gt(P)[i]._gsap, e._ptLookup[i] = p = {}, ht[h.id] && Ft(), c = O === P ? i : O.indexOf(o), f && !1 !== (D = new f).init(o, d || r, e, c, O) && (e._pt = a = new un(e._pt, o, D.name, 0, 1, D.render, D, 0, D.priority), D._props.forEach((function (t) {
                        p[t] = a
                    })), D.priority && (l = 1)), !f || d) for (s in r) ft[s] && (D = ze(s, r, e, c, o, O)) ? D.priority && (l = 1) : p[s] = a = Ie.call(e, o, s, "get", r[s], c, O, 0, g.stringFilter);
        ...
        Ve = (Xe + ",id,stagger,delay,duration,paused").split(","), Ue = function (t) {
            function e(e, n, i, s) {
                var a;
                "number" == typeof n && (i.duration = n, n = i, i = null);
                var o, l, h, f, D, p, c, d, g = (a = t.call(this, s ? n : St(n), i) || this).vars, _ = g.duration,
                    m = g.delay, v = g.immediateRender, y = g.stagger, C = g.overwrite, x = g.keyframes, F = g.defaults,
                    w = a.parent, E = (H(e) ? j(e[0]) : "length" in n) ? [e] : te(e);
                if (a._targets = E.length ? gt(E) : ut("GSAP target " + e + " not found. https://greensock.com", !P.nullTargetWarn) || [], a._ptLookup = [], a._overwrite = C, x || y || q(_) || q(m)) {
                    if (n = a.vars, (o = a.timeline = new Le({
                        data: "nested",
                        defaults: F || {}
                    })).kill(), o.parent = r(a), x) Tt(o.vars.defaults, {ease: "none"}), x.forEach((function (t) {
                        return o.to(E, t, ">")
                    })); else {
                        if (f = E.length, c = y ? ne(y) : at, V(y)) for (D in y) ~Xe.indexOf(D) && (d || (d = {}), d[D] = y[D]);
                        for (l = 0; l < f; l++) {
            ...
            return n.render = function (t, e, n) {
                var r, i, u, s, a, o, l, h, f, D = this._time, p = this._tDur, c = this._dur,
                ...
                if (c) {
                    ...
                    var i, u = t._zTime < 0 ? 0 : 1, s = e < 0 ? 0 : 1, a = t._rDelay, o = 0;
                ...
                var n, r, i, u, s, a, o, l = this._targets, h = t ? te(t) : l, f = this._ptLookup, D = this._pt;
                ...
                for (n = this._op = this._op || [], "all" !== e && (z(e) && (s = {}, vt(e, (function (t) {
                    ...
                    var n, r, i, u, s = t[0] ? _t(t[0]).harness : 0, a = s && s.aliases;
                    if (!a) return e;
                    for (r in n = Mt({}, e), a) if (r in n) for (i = (u = a[r].split(",")).length; i--;) n[u[i]] = n[r];
                    return n
                }(l, e)), o = l.length; o--;) if (~h.indexOf(l[o])) for (s in r = f[o], "all" === e ? (n[o] = e, u = r, i = {}) : (i = n[o] = n[o] || {}, u = e), u) (a = r && r[s]) && ("kill" in a.d && !0 !== a.d.kill(s) || Ot(this, a, "_pt"), delete r[s]), "all" !== i && (i[s] = 1);
    ...
    Tt(Ue.prototype, {
        ...
        Ue[t] = function () {
            var e = new Le, n = Zt.call(arguments, 0);
    ...
    var sn = {
        ...
        quickSetter: function (t, e, n) {
            ...
            t = t[0] || {};
            var u = ft[e], s = _t(t), a = u ? function (e) {
                var r = new u;
        ...
        registerEffect: function (t) {
            var e = t.name, n = t.effect, r = t.plugins, i = t.defaults, u = t.extendTimeline;
        ...
        utils: {
            wrap: function t(e, n, r) {
            ...
            }, distribute: ne, random: ue, snap: ie, normalize: function (t, e, n) {
                return oe(t, e, 0, 1, n)
            }, getUnit: Kt, clamp: function (t, e, n) {
                return Gt(n, (function (n) {
                    return Qt(t, e, n)
                }))
            }, splitColor: de, toArray: te, mapRange: oe, pipe: function () {
                for (var t = arguments.length, e = new Array(t), n = 0; n < t; n++) e[n] = arguments[n];
                return function (t) {
                ...
                if (!u) {
                    var s, a, o, l, h, f = z(e), D = {};
                    if (!0 === r && (i = 1) && (r = null), f) e = {p: e}, n = {p: n}; else if (H(e) && !H(n)) {
    ...
    vt("to,from,fromTo,delayedCall,set,killTweensOf", (function (t) {
        return sn[t] = Ue[t]
    })), Ce.add(Le.updateRoot), f = sn.to({}, {duration: 0});
    var an = function (t, e) {
            ...
            name: t, rawVars: 1, init: function (t, n, r) {
                r._onInit = function (t) {
                    ...
                    !function (t, e) {
                        ...
                        for (n in e) for (r = u.length; r--;) (i = t._ptLookup[r][n]) && (i = i.d) && (i._pt && (i = an(i, n)), i && i.modifier && i.modifier(e[n], t, u[r], n))
                    }(t, n)
                }
            }
        }
     ...
     * @author: Jack Doyle, jack@greensock.com
    */
    var hn, fn, Dn, pn, cn, dn, gn, _n, mn = {}, vn = 180 / Math.PI, yn = Math.PI / 180, Cn = Math.atan2,
        xn = /([A-Z])/g, Fn = /(?:left|right|width|margin|padding|x)/i, wn = /[\s,\(]\S/,
        En = {autoAlpha: "opacity,visibility", scale: "scaleX,scaleY", alpha: "opacity"}, bn = function (t, e) {
        ...
        }, In = "transform", zn = In + "Origin", Yn = function (t, e) {
        ...
        }, Xn = "O,Moz,ms,Ms,Webkit".split(","), Vn = function (t, e, n) {
            var r = (e || cn).style, i = 5;
            if (t in r && !n) return t;
            for (t = t.charAt(0).toUpperCase() + t.substr(1); i-- && !(Xn[i] + t in r);) ;
            return i < 0 ? null : (3 === i ? "ms" : i >= 0 ? Xn[i] : "") + t
        }, Un = function () {
            "undefined" != typeof window && (hn = window, fn = hn.document, Dn = fn.documentElement, cn = Yn("div") || {style: {}}, dn = Yn("div"), In = Vn(In), zn = Vn(zn), cn.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", _n = !!Vn("perspective"), pn = 1)
        }, Wn = function t(e) {
            var n,
                r = Yn("svg", this.ownerSVGElement && this.ownerSVGElement.getAttribute("xmlns") || "http://www.w3.org/2000/svg"),
                i = this.parentNode, u = this.nextSibling, s = this.style.cssText;
        ...
        }, Zn = {deg: 1, rad: 1, turn: 1}, $n = function t(e, n, r, i) {
            var u, s, a, o, l = parseFloat(r) || 0, h = (r + "").trim().substr((l + "").length) || "px", f = cn.style,
                D = Fn.test(n), p = "svg" === e.tagName.toLowerCase(),
                c = (p ? "client" : "offset") + (D ? "Width" : "Height"), d = "px" === i, g = "%" === i;
            ...
            if (!n || "none" === n) {
                var i = Vn(e, t, 1), u = i && jn(t, i, 1);
                u && u !== n && (e = i, n = u)
            }
            var s, a, o, l, h, f, D, p, c, d, g, _, m = new un(this._pt, t.style, e, 0, 1, $e), v = 0, y = 0;
        ...
        }, er = {top: "0%", bottom: "100%", left: "0%", right: "100%", center: "50%"}, nr = function (t, e) {
            if (e.tween && e.tween._time === e.tween._dur) {
                var n, r, i, u = e.t, s = u.style, a = e.u, o = u._gsap;
                if ("all" === a || !0 === a) s.cssText = "", r = 1; else for (i = (a = a.split(",")).length; --i > -1;) n = a[i], mn[n] && (r = 1, n = "transformOrigin" === n ? zn : In), Qn(u, n);
        ...
        }, ir = [1, 0, 0, 1, 0, 0], ur = {}, sr = function (t) {
            return "matrix(1, 0, 0, 1, 0, 0)" === t || "none" === t || !t
        }, ar = function (t) {
            var e = jn(t, In);
            return sr(e) ? ir : e.substr(7).match(Q).map(yt)
        }, or = function (t, e) {
            var n, r, i, u, s = t._gsap || _t(t), a = t.style, o = ar(t);
            ...
            var s, a, o, l = t._gsap, h = i || or(t, !0), f = l.xOrigin || 0, D = l.yOrigin || 0, p = l.xOffset || 0,
                c = l.yOffset || 0, d = h[0], g = h[1], _ = h[2], m = h[3], v = h[4], y = h[5], C = e.split(" "),
                x = parseFloat(C[0]) || 0, F = parseFloat(C[1]) || 0;
            ...
            var n = e || this, r = n.xPercent, i = n.yPercent, u = n.x, s = n.y, a = n.z, o = n.rotation, l = n.rotationY,
                h = n.rotationX, f = n.skewX, D = n.skewY, p = n.scaleX, c = n.scaleY, d = n.transformPerspective,
                g = n.force3D, _ = n.target, m = n.zOrigin, v = "", y = "auto" === g && t && 1 !== t || !0 === g;
            if (m && ("0deg" !== h || "0deg" !== l)) {
                var C, x = parseFloat(l) * yn, F = Math.sin(x), w = Math.cos(x);
            ...
            var n, r, i, u, s, a = e || this, o = a.xPercent, l = a.yPercent, h = a.x, f = a.y, D = a.rotation, p = a.skewX,
                c = a.skewY, d = a.scaleX, g = a.scaleY, _ = a.target, m = a.xOrigin, v = a.yOrigin, y = a.xOffset,
                C = a.yOffset, x = a.forceCSS, F = parseFloat(h), w = parseFloat(f);
            ...
            var s, a, o = z(i), l = parseFloat(i) * (o && ~i.indexOf("rad") ? vn : 1), h = u ? l * u : l - r,
                f = r + h + "deg";
            ...
            var r, i, u, s, a, o, l, h = dn.style, f = n._gsap;
    ...
    vt("padding,margin,Width,Radius", (function (t, e) {
        var n = "Top", r = "Right", i = "Bottom", u = "Left",
    ...
    var mr, vr, yr = {
        name: "css", register: Un, targetTest: function (t) {
            ...
            var u, s, a, o, l, h, f, D, p, c, d, g, _, m, v, y, C, x, F, w = this._props, E = t.style;
            for (f in pn || Un(), e) if ("autoRound" !== f && (s = e[f], !ft[f] || !ze(f, e, n, r, t, i))) if (l = typeof s, h = rr[f], "function" === l && (l = typeof (s = s.call(n, r, t, i))), "string" === l && ~s.indexOf("random(") && (s = ae(s)), h) h(this, t, f, s, n) && (v = 1); else if ("--" === f.substr(0, 2)) this.add(E, "setProperty", getComputedStyle(t).getPropertyValue(f) + "", s + "", r, i, 0, 0, f); else {
                if (u = Jn(t, f), o = parseFloat(u), (c = "string" === l && "=" === s.charAt(1) ? +(s.charAt(0) + "1") : 0) && (s = s.substr(2)), a = parseFloat(s), f in En && ("autoAlpha" === f && (1 === o && "hidden" === Jn(t, "visibility") && a && (o = 0), Kn(this, E, "visibility", o ? "inherit" : "hidden", a ? "inherit" : "hidden", !a)), "scale" !== f && "transform" !== f && ~(f = En[f]).indexOf(",") && (f = f.split(",")[0])), d = f in mn) if (g || ((_ = t._gsap).renderTransform || hr(t), m = !1 !== e.smoothOrigin && _.smooth, (g = this._pt = new un(this._pt, E, In, 0, 1, _.renderTransform, _, 0, -1)).dep = 1), "scale" === f) this._pt = new un(this._pt, _, "scaleY", _.scaleY, c ? c * a : a - _.scaleY), w.push("scaleY", f), f += "X"; else {
                ...
                if (d || (a || 0 === a) && (o || 0 === o) && !wn.test(s) && f in E) a || (a = 0), (D = (u + "").substr((o + "").length)) !== (p = (s + "").substr((a + "").length) || (f in P.units ? P.units[f] : D)) && (o = $n(t, f, u, p)), this._pt = new un(this._pt, d ? _ : E, f, o, c ? c * a : a - o, "px" !== p || !1 === e.autoRound || d ? bn : Mn), this._pt.u = p || 0, D !== p && (this._pt.b = u, this._pt.r = An); else if (f in E) tr.call(this, t, f, u, s); else {
                    if (!(f in t)) {
                        it(f, s);
                        continue
                    }
            ...
            v && rn(this)
        }, get: Jn, aliases: En, getSetter: function (t, e, n) {
            var r = En[e];
        ...
        }, core: {_removeProperty: Qn, _getMatrix: or}
    };
    ...
    var Cr, xr, Fr, wr = ln.registerPlugin(yr) || ln, Er = wr.core.Tween, br = function () {
        ...
        Cr = br(), (Fr = Cr && Cr.parseEase("_CE")) ? (xr = 1, Cr.parseEase("bounce").config = function (t) {
            return "object" == typeof t ? Mr("", t) : Mr("bounce(" + t + ")", {strength: +t})
        }) : t && console.warn("Please gsap.registerPlugin(CustomEase, CustomBounce)")
    }, Ar = function (t) {
        var e, n = t.length, r = 1 / t[n - 2];
        for (e = 2; e < n; e += 2) t[e] = ~~(t[e] * r * 1e3) / 1e3;
        t[n - 2] = 1
    }, Mr = function (t, e) {
        xr || Tr(1), e = e || {};
        var n, r, i, u, s, a, o, l = Math.min(.999, e.strength || .7), h = l, f = (e.squash || 0) / 100, D = f,
            p = 1 / .03, c = .2, d = 1, g = .1, _ = [0, 0, .07, 0, .1, 1, .1, 1], m = [0, 0, 0, 0, .1, 0, .1, 0];
    ...
    */
     ...
     * @author: Jack Doyle, jack@greensock.com
    */
    var Br = /[achlmqstvz]|(-?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi, Sr = /(?:(-)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,
        Or = /[\+\-]?\d*\.?\d+e[\+\-]?\d+/gi, kr = /(^[#\.][a-z]|[a-y][a-z])/i, Lr = Math.PI / 180, Nr = 180 / Math.PI,
        Rr = Math.sin, Ir = Math.cos, zr = Math.abs, Yr = Math.sqrt, jr = Math.atan2, Xr = function (t) {
            return "string" == typeof t
        }, Vr = function (t) {
            return "number" == typeof t
        }, Ur = {}, Wr = {}, qr = function (t) {
            ...
            var n = t.length, r = t[n - 1] || [], i = r.length;
    ...
    function ti(t, e) {
        ...
        return "path" !== w && t.getBBox ? (a = function (t, e) {
            var n, r = document.createElementNS("http://www.w3.org/2000/svg", "path"), i = [].slice.call(t.attributes),
                u = i.length;
    ...
    function ni(t, e, n) {
        void 0 === n && (n = 1);
        var r = (e = e || 0) > n, i = Math.max(0, ~~(zr(n - e) - 1e-8));
        ...
        var s, a, o, l, h, f, D, p = function (t) {
                ...
                return Qr(t, e)
            }(t.totalLength ? t : ii(t)), c = n > 1, d = si(p, e, Ur, !0), g = si(p, n, Wr), _ = g.segment, m = d.segment,
            v = g.segIndex, y = d.segIndex, C = g.i, x = d.i, F = y === v, w = C === x && F,
            E = F && x > C || w && d.t > g.t;
        if (c || i) {
            if (Gr(p, y, x, d.t) && (s = 1, y++, w ? E ? g.t /= d.t : (g.t = (g.t - d.t) / (1 - d.t), v++, C = 0) : y <= v + 1 && !E && (v++, F && (C -= x))), g.t ? Gr(p, v, C, g.t) && (E && s && y++, r && v++) : (v--, r && y--), l = [], f = 1 + (h = p.length) * i, D = y, r) for (f += (h - (v = (v || h) - 1) + y) % h, o = 0; o < f; o++) Kr(l, p[D]), D = (D || h) - 1; else for (f += (h - y + v) % h, o = 0; o < f; o++) Kr(l, p[D++ % h]);
            p = l
        } else if (a = 1 === g.t ? 6 : ui(_, C, g.t), e !== n) for (s = ui(m, x, w ? d.t / g.t : d.t), F && (a += s), _.splice(C + a + 2), (s || x) && m.splice(0, x + s), o = p.length; o--;) (o < y || o > v) && p.splice(o, 1); else _.angle = ei(_, C + a, 0), d = _[C += a], g = _[C + 1], _.length = _.totalLength = 0, _.totalPoints = p.totalPoints = 8, _.push(d, g, d, g, d, g, d, g);
    ...
    function ri(t, e, n) {
        ...
        var r, i, u, s, a, o, l, h, f, D, p, c, d, g, _, m, v, y = ~~t.resolution || 12, C = 1 / y,
            x = n ? e + 6 * n + 1 : t.length, F = t[e], w = t[e + 1], E = e ? e / 6 * y : 0, b = t.samples,
            T = t.lookup, A = (e ? t.minLength : 1e8) || 1e8, M = b[E + n * y - 1], P = e ? b[E - 1] : 0;
        for (b.length = T.length = 0, i = e + 2; i < x; i += 6) {
            if (u = t[i + 4] - F, s = t[i + 2] - F, a = t[i] - F, h = t[i + 5] - w, f = t[i + 3] - w, D = t[i + 1] - w, o = l = p = c = 0, zr(u) < 1e-5 && zr(h) < 1e-5 && zr(a) + zr(D) < 1e-5) t.length > 8 && (t.splice(i, 6), i -= 6, x -= 6); else for (r = 1; r <= y; r++) o = l - (l = ((g = C * r) * g * u + 3 * (d = 1 - g) * (g * s + d * a)) * g), p = c - (c = (g * g * h + 3 * d * (g * f + d * D)) * g), (m = Yr(p * p + o * o)) < A && (A = m), P += m, b[E++] = P;
            F += u, w += h
        }
        if (M) for (M -= P; E < b.length; E++) b[E] += M;
    ...
    function ui(t, e, n) {
        if (n <= 0 || n >= 1) return 0;
        var r = t[e], i = t[e + 1], u = t[e + 2], s = t[e + 3], a = t[e + 4], o = t[e + 5], l = r + (u - r) * n,
            h = u + (a - u) * n, f = i + (s - i) * n, D = s + (o - s) * n, p = l + (h - l) * n, c = f + (D - f) * n,
            d = a + (t[e + 6] - a) * n, g = o + (t[e + 7] - o) * n;
    ...
    function si(t, e, n, r) {
        ...
        var i, u, s, a, o, l, h, f = 0, D = t[0];
        if (t.length > 1) {
            for (s = t.totalLength * e, o = l = 0; (o += t[l++].totalLength) < s;) f = l;
    ...
    function ai(t, e, n, r) {
        var i, u, s, a, o, l, h, f, D, p = t[0], c = r || {};
        if ((e < 0 || e > 1) && (e = qr(e)), t.length > 1) {
            for (s = t.totalLength * e, o = l = 0; (o += t[l++].totalLength) < s;) p = t[l];
    ...
    function oi(t, e, n, r, i, u, s) {
        for (var a, o, l, h, f, D = t.length; --D > -1;) for (o = (a = t[D]).length, l = 0; l < o; l += 2) h = a[l], f = a[l + 1], a[l] = h * e + f * r + u, a[l + 1] = h * n + f * i + s;
        return t._dirty = 1, t
    }
    ...
    function li(t, e, n, r, i, u, s, a, o) {
        if (t !== a || e !== o) {
            n = zr(n), r = zr(r);
            var l = i % 360 * Lr, h = Ir(l), f = Rr(l), D = Math.PI, p = 2 * D, c = (t - a) / 2, d = (e - o) / 2,
                g = h * c + f * d, _ = -f * c + h * d, m = g * g, v = _ * _, y = m / (n * n) + v / (r * r);
            y > 1 && (n = Yr(y) * n, r = Yr(y) * r);
            var C = n * n, x = r * r, F = (C * x - C * v - x * m) / (C * v + x * m);
            F < 0 && (F = 0);
            var w = (u === s ? -1 : 1) * Yr(F), E = w * (n * _ / r), b = w * (-r * g / n),
                T = (t + a) / 2 + (h * E - f * b), A = (e + o) / 2 + (f * E + h * b), M = (g - E) / n, P = (_ - b) / r,
                B = (-g - E) / n, S = (-_ - b) / r, O = M * M + P * P, k = (P < 0 ? -1 : 1) * Math.acos(M / Yr(O)),
                L = (M * S - P * B < 0 ? -1 : 1) * Math.acos((M * B + P * S) / Yr(O * (B * B + S * S)));
            isNaN(L) && (L = D), !s && L > 0 ? L -= p : s && L < 0 && (L += p), k %= p, L %= p;
            var N, R = Math.ceil(zr(L) / (p / 4)), I = [], z = L / R, Y = 4 / 3 * Rr(z / 2) / (1 + Ir(z / 2)),
                j = h * n, X = f * n, V = f * -r, U = h * r;
    ...
    function hi(t) {
        var e, n, r, i, u, s, a, o, l, h, f, D, p, c, d, g = (t + "").replace(Or, (function (t) {
            ...
            })).match(Br) || [], _ = [], m = 0, v = 0, y = g.length, C = 0, x = "ERROR: malformed path: " + t,
            F = function (t, e, n, r) {
        ...
        for (e = 0; e < y; e++) if (p = u, isNaN(g[e]) ? s = (u = g[e].toUpperCase()) !== g[e] : e--, r = +g[e + 1], i = +g[e + 2], s && (r += m, i += v), e || (o = r, l = i), "M" === u) a && (a.length < 8 ? _.length -= 1 : C += a.length), m = o = r, v = l = i, a = [r, i], _.push(a), e += 2, u = "L"; else if ("C" === u) a || (a = [0, 0]), s || (m = v = 0), a.push(r, i, m + 1 * g[e + 3], v + 1 * g[e + 4], m += 1 * g[e + 5], v += 1 * g[e + 6]), e += 6; else if ("S" === u) h = m, f = v, "C" !== p && "S" !== p || (h += m - a[a.length - 4], f += v - a[a.length - 3]), s || (m = v = 0), a.push(h, f, r, i, m += 1 * g[e + 3], v += 1 * g[e + 4]), e += 4; else if ("Q" === u) h = m + 2 / 3 * (r - m), f = v + 2 / 3 * (i - v), s || (m = v = 0), m += 1 * g[e + 3], v += 1 * g[e + 4], a.push(h, f, m + 2 / 3 * (r - m), v + 2 / 3 * (i - v), m, v), e += 4; else if ("T" === u) h = m - a[a.length - 4], f = v - a[a.length - 3], a.push(m + h, v + f, r + 2 / 3 * (m + 1.5 * h - r), i + 2 / 3 * (v + 1.5 * f - i), m = r, v = i), e += 2; else if ("H" === u) F(m, v, m = r, v), e += 1; else if ("V" === u) F(m, v, m, v = r + (s ? v - m : 0)), e += 1; else if ("L" === u || "Z" === u) "Z" === u && (r = o, i = l, a.closed = !0), ("L" === u || zr(m - r) > .5 || zr(v - i) > .5) && (F(m, v, r, i), "L" === u && (e += 2)), m = r, v = i; else if ("A" === u) {
            if (c = g[e + 4], d = g[e + 5], h = g[e + 6], f = g[e + 7], n = 7, c.length > 1 && (c.length < 3 ? (f = h, h = d, n--) : (f = d, h = c.substr(2), n -= 2), d = c.charAt(1), c = c.charAt(0)), D = li(m, v, +g[e + 1], +g[e + 2], +g[e + 3], +c, +d, (s ? m : 0) + 1 * h, (s ? v : 0) + 1 * f), e += n, D) for (n = 0; n < D.length; n++) a.push(D[n]);
    ...
    function Di(t, e, n) {
        var r, i, u, s, a, o, l, h, f, D, p, c, d, g, _ = t.length - 2, m = +t[0], v = +t[1], y = +t[2], C = +t[3],
            x = [m, v, m, v], F = y - m, w = C - v;
    ...
    */
    var ci, di, gi = function () {
        ...
        }, vi = /[-+=\.]*\d+[\.e\-\+]*\d*[e\-\+]*\d*/gi, yi = /[cLlsSaAhHvVtTqQ]/g,
        Ci = function t(e, n, r, i, u, s, a, o, l, h, f) {
            var D, p = (e + r) / 2, c = (n + i) / 2, d = (r + u) / 2, g = (i + s) / 2, _ = (u + a) / 2, m = (s + o) / 2,
                v = (p + d) / 2, y = (c + g) / 2, C = (d + _) / 2, x = (g + m) / 2, F = (v + C) / 2, w = (y + x) / 2,
                E = a - e, b = o - n, T = Math.abs((r - a) * b - (i - o) * E), A = Math.abs((u - a) * b - (s - o) * E);
            return h || (h = [{x: e, y: n}, {x: a, y: o}], f = 1), h.splice(f || h.length - 1, 0, {
                x: F,
                y: w
            ...
            return e.setData = function (t, e) {
                e = e || {};
                var n, r, i, u, s, a, o, l, h, f = (t = t || "0,0,1,1").match(vi), D = 1, p = [], c = [],
                    d = e.precision || 1, g = d <= 1;
                if (this.data = t, (yi.test(t) || ~t.indexOf("M") && t.indexOf("C") < 0) && (f = hi(t)[0]), 4 === (n = f.length)) f.unshift(0, 0), f.push(1, 1), n = 8; else if ((n - 2) % 6) throw"Invalid CustomEase";
                for (0 == +f[0] && 1 == +f[n - 2] || function (t, e, n) {
                    n || 0 === n || (n = Math.max(+t[t.length - 1], +t[1]));
                    var r, i = -1 * +t[0], u = -n, s = t.length, a = 1 / (+t[s - 2] + i),
                ...
                var r, i, u, s, a, o, l, h, f, D, p = (n = n || {}).width || 100, c = n.height || 100, d = n.x || 0,
                    g = (n.y || 0) + c, _ = ci.utils.toArray(n.path)[0];
                if (n.invert && (c = -c, g = 0), "string" == typeof e && (e = ci.parseEase(e)), e.custom && (e = e.custom), e instanceof t) r = pi(oi([e.segment], p, 0, 0, -c, d, g)); else {
    ...
    */
    var Fi, wi, Ei, bi = function () {
        ...
        if (!wi) if (Fi = bi(), Ei = Fi && Fi.parseEase("_CE")) {
            for (var e in Ti) Ti[e] = Ei("", Ti[e]);
            wi = 1, Bi("wiggle").config = function (t) {
                return "object" == typeof t ? Bi("", t) : Bi("wiggle(" + t + ")", {wiggles: +t})
            }
        ...
        wi || Mi(1);
        var n, r, i, u, s, a, o, l, h, f = 0 | ((e = e || {}).wiggles || 10), D = 1 / f, p = D / 2,
            c = "anticipate" === e.type, d = Ti[e.type] || Ti.easeOut, g = Ai;
    ...
    */
    var Oi, ki, Li, Ni, Ri, Ii = function () {
        ...
        Xi = function (t) {
        ...
        }, Wi = Math.sqrt, qi = function (t, e, n, r, i, u) {
            ...
            var e, n, r, i, u, s, a, o = t.tagName.toLowerCase(), l = t.style, h = 1, f = 1;
            ...
            var D = n || {x: 0, y: 0, width: 0, height: 0}, p = D.x, c = D.y, d = D.width, g = D.height;
            ...
            e || (e = Qi(t) + 1);
            var n = Li.getComputedStyle(t), r = n.strokeDasharray || "", i = Vi(n.strokeDashoffset), u = r.indexOf(",");
            ...
            version: "3.2.6", name: "drawSVG", register: function (t) {
                Oi = t, Zi()
            }, init: function (t, e, n, r, i) {
                ...
                var n, r, i, u, s = e._pt, a = e._style;
                if (s) {
     ...
     * @author: Jack Doyle, jack@greensock.com
    */
    var Ji, tu, eu, nu, ru, iu, uu, su, au = "transform", ou = au + "Origin", lu = function (t) {
        ...
        if (e.parentNode && (Ji || lu(e))) {
            var r = Du(e),
                ...
                u = r ? n ? "rect" : "g" : "div", s = 2 !== n ? 0 : 100, a = 3 === n ? 100 : 0,
        ...
        var n, r, i, u, s, a = Du(t), o = t === a, l = a ? hu : fu;
        if (t === tu) return t;
        if (l.length || l.push(pu(t, 1), pu(t, 2), pu(t, 3)), n = a ? iu : ru, a) i = o ? {
            ...
            return e
        }(r) : r.getItem(0).matrix).a * i.x + r.c * i.y, s = r.b * i.x + r.d * i.y) : (r = uu, u = i.x, s = i.y), e && "g" === t.tagName.toLowerCase() && (u = s = 0), n.setAttribute("transform", "matrix(" + r.a + "," + r.b + "," + r.c + "," + r.d + "," + (r.e + u) + "," + (r.f + s) + ")"), (o ? a : t.parentNode).appendChild(n); else {
            if (u = s = 0, su) for (r = t.offsetParent, i = t; i && (i = i.parentNode) && i !== r && i.parentNode;) (tu.getComputedStyle(i)[au] + "").length > 4 && (u = i.offsetLeft, s = i.offsetTop, i = 0);
        ...
        return e.inverse = function () {
            var t = this.a, e = this.b, n = this.c, r = this.d, i = this.e, u = this.f, s = t * r - e * n;
            return du(this, r / s, -e / s, -n / s, t / s, (n * u - r * i) / s, -(t * u - e * i) / s)
        }, e.multiply = function (t) {
            var e = this.a, n = this.b, r = this.c, i = this.d, u = this.e, s = this.f, a = t.a, o = t.c, l = t.b,
                h = t.d, f = t.e, D = t.f;
            return du(this, a * e + l * r, a * n + l * i, o * e + h * r, o * n + h * i, u + f * e + D * r, s + f * n + D * i)
        }, e.clone = function () {
            return new t(this.a, this.b, this.c, this.d, this.e, this.f)
        }, e.equals = function (t) {
            var e = this.a, n = this.b, r = this.c, i = this.d, u = this.e, s = this.f;
            return e === t.a && n === t.b && r === t.c && i === t.d && u === t.e && s === t.f
        }, e.apply = function (t, e) {
            void 0 === e && (e = {});
            var n = t.x, r = t.y, i = this.a, u = this.b, s = this.c, a = this.d, o = this.e, l = this.f;
    ...
    function _u(t, e, n) {
        ...
        var r = Du(t) ? hu : fu, i = cu(t, n), u = r[0].getBoundingClientRect(), s = r[1].getBoundingClientRect(),
            a = r[2].getBoundingClientRect(), o = i.parentNode, l = function t(e) {
     ...
     * @author: Jack Doyle, jack@greensock.com
    */
    var mu, vu, yu, Cu, xu = ["x", "translateX", "left", "marginLeft"], Fu = ["y", "translateY", "top", "marginTop"],
        wu = Math.PI / 180, Eu = function (t, e, n, r) {
            ...
            return t
        }, Pu = /[-+\.]*\d+[\.e\-\+]*\d*[e\-\+]*\d*/g, Bu = function (t, e, n) {
            var r, i, u, s = _u(t);
            ...
            var i, u = _u(t.parentNode, !0, !0), s = u.clone().multiply(_u(e)), a = Bu(t, n, u), o = Bu(e, r, u), l = o.x,
                h = o.y;
            ...
            var r, i, u, s = n.align, a = n.matrix, o = n.offsetX, l = n.offsetY, h = n.alignOrigin, f = t[0][0],
                D = t[0][1], p = bu(e, "x"), c = bu(e, "y");
            return t && t.length ? (s && ("self" === s || (r = Cu(s)[0] || e) === e ? oi(t, 1, 0, 0, 1, p - f, c - D) : (h && !1 !== h[2] ? mu.set(e, {transformOrigin: 100 * h[0] + "% " + 100 * h[1] + "%"}) : h = [bu(e, "xPercent") / -100, bu(e, "yPercent") / -100], u = (i = Su(e, r, h, "auto")).apply({
                x: f,
                y: D
            ...
            var s = e._gsap, a = s.harness, o = a && a.aliases && a.aliases[n], l = o && o.indexOf(",") < 0 ? o : n,
            ...
            init: function (t, e) {
                ...
                var n, r, i, u, s, a, o = [], l = e.path, h = l[0], f = e.autoRotate,
            ...
            render: function (t, e) {
                var n = e.rawPaths, r = n.length, i = e._pt;
    ...
    */
    var Nu, Ru, Iu, zu, Yu, ju, Xu, Vu = function () {
        ...
        var n = "x" === e ? "Width" : "Height", r = "scroll" + n, i = "client" + n;
        return t === Iu || t === zu || t === Yu ? Math.max(zu[r], Yu[r]) - (Iu["inner" + n] || zu[i] || Yu[i]) : t[r] - t["offset" + n]
    }, Hu = function (t, e) {
        var n = "scroll" + ("x" === e ? "Left" : "Top");
        return t === Iu && (null != t.pageXOffset ? n = "page" + e.toUpperCase() + "Offset" : t = null != zu[n] ? zu : Yu), function () {
            return t[n]
        }
    }, Gu = function (t, e) {
        var n = ju(t)[0].getBoundingClientRect(), r = !e || e === Iu || e === Yu, i = r ? {
        ...
        } : e.getBoundingClientRect(), u = {x: n.left - i.left, y: n.top - i.top};
        ...
        Nu = Uu(), Vu() && Nu && document.body && (Iu = window, Yu = document.body, zu = document.documentElement, ju = Nu.utils.toArray, Nu.config({autoKillThreshold: 7}), Xu = Nu.config(), Ru = 1)
    }, Zu = {
        version: "3.2.6", name: "scrollTo", rawVars: 1, register: function (t) {
            Nu = t, Ku()
        }, init: function (t, e, n, r, i) {
            Ru || Ku();
            this.isWin = t === Iu, this.target = t, this.tween = n, "object" != typeof e ? Wu((e = {y: e}).y) && "max" !== e.y && "=" !== e.y.charAt(1) && (e.x = e.y) : e.nodeType && (e = {
                y: e,
                x: e
    ...
    */
     ...
     * @author: Jack Doyle, jack@greensock.com
    */
    var Ju, ts, es, ns, rs = /(?:\r|\n|\t\t)/g, is = /(?:\s\s+)/g, us = function (t) {
        return ts.getComputedStyle(t)
    }, ss = Array.isArray, as = [].slice, os = function (t, e) {
        var n;
        ...
        var n, r, i = os(e.childNodes), u = i.length;
        ...
        var a, o, l, h, f, D, p, c, d, g, _, m, v = us(t), y = gs("paddingLeft", v), C = -999,
            x = gs("borderBottomWidth", v) + gs("borderTopWidth", v),
            F = gs("borderLeftWidth", v) + gs("borderRightWidth", v), w = gs("paddingTop", v) + gs("paddingBottom", v),
            E = gs("paddingLeft", v) + gs("paddingRight", v), b = .2 * gs("fontSize", v), T = v.textAlign, A = [],
            M = [], P = [], B = e.wordDelimiter || " ", S = e.tag ? e.tag : e.span ? "span" : "div",
            O = e.type || e.split || "chars,words,lines", k = i && ~O.indexOf("lines") ? [] : null,
            L = ~O.indexOf("words"), N = ~O.indexOf("chars"), R = ls(e), I = e.linesClass, z = ~(I || "").indexOf("++"),
            Y = [];
        for (z && (I = I.split("++").join("")), l = (o = t.getElementsByTagName("*")).length, f = [], a = 0; a < l; a++) f[a] = o[a];
        if (k || R) for (a = 0; a < l; a++) ((D = (h = f[a]).parentNode === t) || R || N && !L) && (m = h.offsetTop, k && D && Math.abs(m - C) > b && ("BR" !== h.nodeName || 0 === a) && (p = [], k.push(p), C = m), R && (h._x = h.offsetLeft, h._y = m, h._w = h.offsetWidth, h._h = h.offsetHeight), k && ((h._isSplit && D || !N && D || L && D || !L && h.parentNode.parentNode === t && !h.parentNode._isSplit) && (p.push(h), h._x -= y, cs(h, t, B) && (h._wordEnd = !0)), "BR" === h.nodeName && (h.nextSibling && "BR" === h.nextSibling.nodeName || 0 === a) && k.push([])));
        ...
        var i, u, s, a, o, l, h, f, D = e.tag ? e.tag : e.span ? "span" : "div",
            p = ~(e.type || e.split || "chars,words,lines").indexOf("chars"), c = ls(e), d = e.wordDelimiter || " ",
            g = " " !== d ? "" : c ? "&#173; " : " ", _ = "</" + D + ">", m = 1,
            v = e.specialChars ? "function" == typeof e.specialChars ? e.specialChars : hs : null,
            y = Ju.createElement("div"), C = t.parentNode;
        for (C.insertBefore(y, t), y.textContent = t.nodeValue, C.removeChild(t), h = -1 !== (i = function t(e) {
            ...
            return r
        }(t = y)).indexOf("<"), !1 !== e.reduceWhiteSpace && (i = i.replace(is, " ").replace(rs, "")), h && (i = i.split("<").join("{{LT}}")), o = i.length, u = (" " === i.charAt(0) ? g : "") + n(), s = 0; s < o; s++) if (l = i.charAt(s), v && (f = v(i.substr(s), e.specialChars))) l = i.substr(s, f || 1), u += p && " " !== l ? r() + l + "</" + D + ">" : l, s += f - 1; else if (l === d && i.charAt(s - 1) !== d && s) {
        ...
        var u, s, a = os(e.childNodes), o = a.length, l = ls(n);
        if (3 !== e.nodeType || o > 1) {

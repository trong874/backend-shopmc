...
!function (e, t) {
    ...
    window.RSANYID = window.RSANYID === t ? [] : window.RSANYID, window.RSANYID_sliderID = window.RSANYID_sliderID === t ? [] : window.RSANYID_sliderID, e.fn.extend({
        ...
        pageHandler: function (r) {
            ...
            }, {passive: !0})), i.slidersToScroll.push(e), i.generalObserver(a)
            ...
            if (a !== t && i[a] !== t && "clicked" !== i[a].modal.closeProtection) {
                ...
                switch (r.mode) {
                    case"show":
                        ...
                        var o = {a: 0};
                        i.isModalOpen = !0, tpGS.gsap.fromTo(o, .01, {a: 0}, {
                            a: 10,
                            ease: "power3.inOut",
                            onStart: function () {
                        ...
                        }), tpGS.gsap.fromTo([i[a].modal.c], .01, {opacity: 0}, {
                            opacity: 1,
                            delay: .5,
                            ease: "power3.inOut",
                            onComplete: function () {
                    ...
                    case"init":
                        if (window.RS_60_MODALS = window.RS_60_MODALS === t ? [] : window.RS_60_MODALS, -1 === e.inArray(i[a].modal.alias, window.RS_60_MODALS) && window.RS_60_MODALS.push(i[a].modal.alias), i[a].modal.listener === t && (i[a].modal.c = e("#" + a + "_modal"), i[a].modal.bg = e('<rs-modal-cover data-rid="' + a + '" id="' + a + '_modal_bg"></rs-modal-cover>'), "auto" === i[a].sliderLayout && i[a].modal.cover ? e("body").append(i[a].modal.bg) : i[a].modal.c.append(i[a].modal.bg), i[a].modal.c[0].className += "rs-modal-" + i[a].sliderLayout, i[a].modal.calibration = {
                            ...
                            for (o in i[a].modal.trigger = {}, n) if (n.hasOwnProperty(o)) switch ((s = n[o].split(":"))[0]) {
                                case"t":
            ...
            if (a !== t && 0 !== a.length) {
                var n = [];
                if (e.isArray(a)) for (var l in a) a.hasOwnProperty(l) && a[l] !== t && n.push(a[l]); else n.push(a);
            ...
            if (r !== t && 0 !== r.length && i[o] !== t) {
                var n = !1, l = [];
                if (e.isArray(r)) for (var d in r) r.hasOwnProperty(d) && r[d] !== t && l.push(r[d]); else l.push(r);
                for (var c in l) if (l.hasOwnProperty(c)) {
                    var p = l[c].querySelectorAll("img, rs-sbg, .rs-svg");
                    for (d in p) if (p.hasOwnProperty(d) && "length" !== d && !(p[d].className.indexOf("rs-pzimg") >= 0)) {
                        var u = e(p[d]).data(), h = g(p[d], t, o),
                            ...
                            if (p[d].src = f.src, "img" == f.type) {
                                if (u.slidebgimage) {
                                    ...
                                    if (v.length > 0 && (i.sA(v[0], "owidth", f.width), i.sA(v[0], "oheight", f.height)), "carousel" === i[o].sliderType) {
                                        var y = e(v), b = i.getSlideIndex(o, i.gA(l[c], "key"));
            ...
            var e = ["android", "webos", "iphone", "ipad", "blackberry", "Android", "webos", "iPod", "iPhone", "iPad", "Blackberry", "BlackBerry"],
                i = !1;
            if (window.orientation !== t) i = !0; else for (var a in e) e.hasOwnProperty(a) && (i = !!(i || navigator.userAgent.split(e[a]).length > 1) || i);
            return i
        }, is_android: function () {
            ...
            if ("smart" == i[e].lazyType) {
                var t = [], a = parseInt(i.getSlideIndex(e, i.gA(i[e].pr_next_slide[0], "key")), 0),
                    r = a - 1 < 0 ? i[e].realslideamount - 1 : a - 1, o = a + 1 == i[e].realslideamount ? 0 : a + 1;
            ...
            var o, s, n = parseInt(i[e].top_outer || 0) + parseInt(i[e].bottom_outer || 0), l = 0, d = 0, c = 0,
                p = i[e].pr_processing_key || i[e].pr_active_key || 0, g = i[e].pr_active_key || 0, u = {}, h = {};
            if (u.marginTop = "carousel" == i[e].sliderType ? parseInt(i[e].carousel.padding_top || 0, 0) : 0, u.marginBottom = "carousel" == i[e].sliderType ? parseInt(i[e].carousel.padding_bottom || 0, 0) : 0, i[e].blockSpacing !== t && tpGS.gsap.set(i[e].blockSpacing.block, {
                ...
                if (i[e].rowzones[p] !== t) for (o = 0; o < i[e].rowzones[p].length; o++) i[e].rowzonesHeights[p][o] = i[e].rowzones[p][o][0].offsetHeight, l += i[e].rowzonesHeights[p][o];
                if (g !== p) for (o = 0; o < i[e].rowzones[g].length; o++) i[e].rowzonesHeights[g][o] = i[e].rowzones[g][o][0].offsetHeight, d += i[e].rowzonesHeights[g][o];
                l = d / 2 > l ? d : l
            }
            if (i[e].srowzones && i[e].srowzones.length > 0) for (o = 0; o < i[e].srowzones.length; o++) c += i[e].srowzones[o][0].offsetHeight;
            ...
            if (i.gA(r, "idcheck") === t) {
                ...
                -1 !== s && (n = e.inArray(r.id, i[a].anyid), window.RSANYID_sliderID[s] === a && -1 === n || (r.id = r.id + "_" + Math.round(9999 * Math.random()), console.log("Warning - ID:" + o + " exists already. New Runtime ID:" + r.id), s = n = -1)), -1 === n && i[a].anyid.push(r.id), -1 === s && (window.RSANYID.push(r.id), window.RSANYID_sliderID.push(a))
            }
    ...
    var a = i.is_mobile(), r = (i.is_android(), function (e) {
        ...
        if (i[r].cpar !== t && i[r].cpar.data("aimg") != t && ("enabled" == i[r].cpar.data("aie8") && i.isIE(8) || "enabled" == i[r].cpar.data("amobile") && a)) i[r].c.html('<img class="tp-slider-alternative-image" src="' + i[r].cpar.data("aimg") + '">'); else {
            ...
            var l = i[r].canvas[0].getElementsByTagName("rs-slide"), d = [];
        ...
        if (i[r] !== t) {
            ...
            for (var u in i[r].slides) if (i[r].slides.hasOwnProperty(u) && "length" !== u) {
                var h = i[r].slides[u], f = h.getElementsByTagName("img")[0];
                ...
                i.gA(h, "title") === t && i.sA(h, "title", ""), i.gA(h, "description") === t && i.sA(h, "description", ""), v.params[0] = {
                    from: RegExp("\\{\\{title\\}\\}", "g"),
                    to: i.gA(h, "title")
                }, v.params[1] = {from: RegExp("\\{\\{description\\}\\}", "g"), to: i.gA(h, "description")};
                for (var b = 1; b <= 10; b++) i.gA(h, "p" + b) !== t ? v.params[b + 1] = {
                    from: RegExp("\\{\\{param" + b + "\\}\\}", "g"),
                    to: i.gA(h, "p" + b)
                } : v.params[b + 1] = {from: RegExp("\\{\\{param" + b + "\\}\\}", "g"), to: ""};
                if (i[r].thumbs[d] = e.extend({}, !0, v), c > 0 && tpGS.gsap.set(h, {borderRadius: c + "px"}), i.gA(h, "link") != t || i.gA(h, "linktoslide") !== t) {
                    var _ = i.gA(h, "link") !== t ? i.gA(h, "link") : "slide",
                        w = "slide" != _ ? "no" : i.gA(h, "linktoslide"), x = i.gA(h, "seoz");
                    if (w != t && "no" != w && "next" != w && "prev" != w) for (var k in i[r].slides) i[r].slides.hasOwnProperty(k) && parseInt(i.gA(i[r].slides[k], "origindex"), 0) + 1 == i.gA(h, "linktoslide") && (w = i.gA(i[r].slides[k], "key"));
            ...
            if (i[r].simplifyAll && (i.isIE(8) || i.iOSVersion()) && (i[r].c.find(".rs-layer").each(function () {
                ...
                var S = i[r].cpar[0].style.marginTop, L = i[r].cpar[0].style.marginBottom;
            ...
            if (i[r].forceOverflow && i[r].topc[0].classList.add("rs-forceoverflow"), "carousel" === i[r].sliderType && !0 !== i[r].overflowHidden && i[r].c.css({overflow: "visible"}), 0 !== i[r].maxHeight && tpGS.gsap.set([i[r].cpar, i[r].c, i[r].topc], {maxHeight: i[r].maxHeight + "px"}), i[r].fixedOnTop && tpGS.gsap.set(i[r].blockSpacing !== t && i[r].blockSpacing.block !== t ? i[r].blockSpacing.block : i[r].topc, {
                position: "fixed",
                top: "0px",
                left: "0px",
                pointerEvents: "none",
                ...
                i[r].c[0].classList.add("revslider-initialised"), i[r].c[0].id = i[r].c[0].id === t ? "revslider-" + Math.round(1e3 * Math.random() + 5) : i[r].c[0].id, i.revCheckIDS(r, i[r].c[0]), i[r].origcd = parseInt(i[r].duration, 0), i[r].scrolleffect._L = [], i[r].sbas = i[r].sbas === t ? {} : i[r].sbas, i[r].layers = i[r].layers || {}, i[r].sortedLayers = i[r].sortedLayers || {}, i[r].c.find("rs-layer, rs-row, rs-column, rs-group,  rs-bgvideo, .rs-layer").each(function () {
                    ...
                    if ("true" != n.animationonscroll && 1 != n.animationonscroll || (n.startclasses += " rs-sba", s[0].className += " rs-sba"), n.startclasses.indexOf("rs-layer-static") >= 0 && i.handleStaticLayers && i.handleStaticLayers(s, r), "RS-BGVIDEO" !== s[0].tagName) {
                        ...
                        var c = n.startclasses.indexOf("slidelink") >= 0 ? "width:100% !important;height:100% !important;" : "",
                            ...
                            m = "", f = "", v = (n.noPevents, ";pointer-events:none");
                ...
                var A = i[r].viewPort;
                for (var b in i[r].slides) if (i[r].slides.hasOwnProperty(b)) {
                ...
                i[r].srowzones = [], i[r].smiddleZones = [], i[r].slayers && i[r].slayers.find("rs-zone").each(function () {
                    ...
                    transformStyle: "flat",
                    opacity: 0
                }), i[r].c.prependTo(i[r].cpar), e("body").data("rs-fullScreenMode", !1), window.addEventListener("fullscreenchange", p, {passive: !0}), window.addEventListener("mozfullscreenchange", p, {passive: !0}), window.addEventListener("webkitfullscreenchange", p, {passive: !0}), i.document.on("updateContainerSizes." + i[r].c.attr("id"), function () {
                    if (i[r] !== t) {
                        if (i[r].c == t) return !1;
        ...
        if (i[e].dimensionReCheck = {}, i[e].dimensionChanged = !0, i[e].c.trigger("revolution.slide.beforeredraw"), 1 == i[e].infullscreenmode && (i[e].minHeight = i.getWinH(e)), a && (i[e].lastMobileHeight = i.getWinH(e)), l(e), !i.resizeThumbsTabs || !0 === i.resizeThumbsTabs(e)) {
            if (window.requestAnimationFrame(function () {
                ...
                })), "carousel" === i[e].sliderType) for (var o in i[e].panzoomTLs) i[e].panzoomTLs.hasOwnProperty(o) && i.startPanZoom(i[e].panzoomBGs[o], e, i[e].panzoomTLs[o].progress(), o, i[e].panzoomTLs[o].isActive() ? "play" : "reset"); else f(e, i[e].pr_active_bg), f(e, i[e].pr_next_bg);
        ...
        if (!0 !== i[a].noDetach && i[a].canvas.detach(), i[a].autoHeight && tpGS.gsap.set([i[a].c, i[a].cpar], {maxHeight: "none"}), tpGS.gsap.set(i[a].canvas, i[a].modal !== t && i[a].modal.useAsModal ? {
            overflow: "hidden",
            width: "100%",
            height: "100%"
        } : {
        ...
        for (var o = 0; o < i[a].slides.length; o++) {
            var s = e(i[a].slides[o]), n = s.find(">img"), l = s.find("rs-bgvideo");
            ...
            var d = n.closest("rs-sbg-wrap"), c = s.data("mediafilter"), p = b(n.data(), a),
        ...
        i[a] !== t && (i[a].pr_active_slide = e(i[a].slides[i[a].pr_active_key]), i[a].pr_next_slide = e(i[a].slides[i[a].pr_processing_key]), i[a].pr_active_bg = i[a].pr_active_slide.find("rs-sbg-wrap"), i[a].pr_next_bg = i[a].pr_next_slide.find("rs-sbg-wrap"), i[a].pr_active_bg !== t && i[a].pr_active_bg.length > 0 && tpGS.gsap.to(i[a].pr_active_bg, .5, {opacity: 0}), i[a].pr_next_bg !== t && i[a].pr_next_bg.length > 0 && tpGS.gsap.to(i[a].pr_next_bg, .5, {opacity: 0}), tpGS.gsap.set(i[a].pr_active_slide, {zIndex: 18}), i[a].pr_next_slide !== t && i[a].pr_next_slide.length > 0 && tpGS.gsap.set(i[a].pr_next_slide, {
            autoAlpha: 0,
            zIndex: 20
        ...
        if (i[a] !== t) if (clearTimeout(i[a].waitWithSwapSlide), i[a].pr_processing_key === t || !0 !== i[a].firstSlideShown) {
        ...
        if (i[r] !== t) {
            ...
            }, i[r].c.trigger("revolution.slide.onbeforeswap", i[r].onBeforeSwap), i[r].transition = 1, i[r].stopByVideo = !1, i[r].pr_next_slide[0] !== t && i.gA(i[r].pr_next_slide[0], "duration") != t && "" != i.gA(i[r].pr_next_slide[0], "duration") ? i[r].duration = parseInt(i.gA(i[r].pr_next_slide[0], "duration"), 0) : i[r].duration = i[r].origcd, i[r].pr_next_slide[0] === t || "true" != i.gA(i[r].pr_next_slide[0], "ssop") && !0 !== i.gA(i[r].pr_next_slide[0], "ssop") ? i[r].ssop = !1 : i[r].ssop = !0, i[r].sbtimeline.set && i[r].sbtimeline.fixed && i.updateFixedScrollTimes(r), i[r].c.trigger("nulltimer"), i[r].sdir = i[r].pr_processing_key < i[r].pr_active_key ? 1 : 0, "arrow" == i[r].sc_indicator && (0 == i[r].pr_active_key && i[r].pr_processing_key == i[r].slideamount - 1 && (i[r].sdir = 1), i[r].pr_active_key == i[r].slideamount - 1 && 0 == i[r].pr_processing_key && (i[r].sdir = 0)), i[r].lsdir = i[r].sdir, i[r].pr_active_key != i[r].pr_processing_key && 1 != i[r].firststart && "carousel" !== i[r].sliderType && i.removeTheLayers && i.removeTheLayers(i[r].pr_active_slide, r), 1 !== i.gA(i[r].pr_next_slide[0], "rspausetimeronce") && 1 !== i.gA(i[r].pr_next_slide[0], "rspausetimeralways") ? i[r].c.trigger("restarttimer") : (i[r].stopByVideo = !0, i.unToggleState(i[r].slidertoggledby)), i.sA(i[r].pr_next_slide[0], "rspausetimeronce", 0), i[r].pr_next_slide[0] !== t && i.sA(i[r].c[0], "slideactive", i.gA(i[r].pr_next_slide[0], "key")), "carousel" == i[r].sliderType) i[r].mtl = tpGS.gsap.timeline(), i.prepareCarousel(r), z(r), i.playBGVideos(r, "carousel"), i[r].transition = 0; else {
                i[r].mtl = tpGS.gsap.timeline({
                    paused: !0, onComplete: function () {
                        z(r)
                    }
                }), i[r].mtl.add(tpGS.gsap.set(i[r].pr_next_bg.find("rs-sbg"), {opacity: 0})), i[r].pr_next_key !== t ? i.animateTheLayers({
                    slide: i[r].pr_next_key,
                    id: r,
                    mode: "preset",
                    caller: "swapSlideProgress_1"
                    ...
                    mode: "preset",
                    caller: "swapSlideProgress_3"
                }), 1 == i[r].firststart && (i[r].pr_active_slide[0] !== t && tpGS.gsap.set(i[r].pr_active_slide, {autoAlpha: 0}), i[r].firststart = 0), i[r].pr_active_slide[0] !== t && tpGS.gsap.set(i[r].pr_active_slide, {zIndex: 18}), i[r].pr_next_slide[0] !== t && tpGS.gsap.set(i[r].pr_next_slide, {
                    autoAlpha: 0,
                    zIndex: 20
            ...
            i.animateTheLayers ? "carousel" === i[r].sliderType ? (!1 !== i[r].carousel.showLayersAllTime && (i[r].carousel.allLayersStarted ? i.animateTheLayers({
                ...
                i[r].mtl.resume()
            }, 18), "carousel" !== i[r].sliderType && tpGS.gsap.to(i[r].pr_next_slide, .001, {autoAlpha: 1})
        }
    };
    var z = function (r) {
        if (i[r] !== t) {
            ...
            })), "carousel" === i[r].sliderType ? tpGS.gsap.to(i[r].carousel.wrap, 1, {opacity: 1}) : (tpGS.gsap.set(i[r].pr_next_bg.find("rs-sbg"), {
                zIndex: 20,
                autoAlpha: 1
        ...
        if (i[a].progressC === t || 0 == i[a].progressC.length) if (i[a].progressC = e('<rs-progress style="visibility:hidden;"></rs-progress>'), "horizontal" === r.style || "vertical" === r.style) {
            if ("module" === r.basedon) {
        ...
        if (!0 !== i[a].noDetach && i[a].progressC.detach(), i[a].progressBar.visibility[i[a].level] && 1 != i[a].progressBar.disableProgressBar) if ("horizontal" === r.style || "vertical" === r.style) {
            ...
            if ("horizontal" === r.style) {
                ...
                n = Math.ceil(c / i[a].slideamount), l = Math.ceil((c - d * r.gapsize) / i[a].slideamount), tpGS.gsap.set(i[a].progressC, {
                    ...
                    } : 0, width: "module" === r.basedon ? r.gap ? l + "px" : 100 / i[a].slideamount + "%" : "100%"
                ...
                n = Math.ceil(c / i[a].slideamount), l = Math.ceil((c - d * r.gapsize) / i[a].slideamount), tpGS.gsap.set(i[a].progressC, {
                    ...
                    } : 0, height: "module" === r.basedon ? r.gap ? l + "px" : 100 / i[a].slideamount + "%" : "100%"
                }), "module" === r.basedon && (tpGS.gsap.set(i[a].progressCBarBGS, {
                    y: "module" === r.basedon ? r.gap ? function (e) {
                        return e * (l + r.gapsize)
                    } : function (e) {
        ...
        var t = i[e].progressBar, a = parseInt(t.radius), r = parseInt(t.radius);
        ...
        if (n = n === t ? 0 : n, "horizontal" === i[a].progressBar.style) {
            ...
            })), "module" === i[a].progressBar.basedon) for (var l = 0; l < i[a].slideamount; l++) l !== n && o.add(tpGS.gsap.set(i[a].progressCBarInner[l], {
                scaleX: l < n ? 1 : 0,
                transformOrigin: "right" === i[a].progressBar.horizontal ? "100% 50%" : "0% 50%"
            }), 0)
            ...
            if (i[a].progressCBarInner[n] !== t && o.add(tpGS.gsap.to(i[a].progressCBarInner[n], s, {
                ...
                delay: .5,
                ease: i[a].progressBar.ease
            })), "module" === i[a].progressBar.basedon) for (l = 0; l < i[a].slideamount; l++) l !== n && i[a].progressCBarInner[l] !== t && o.add(tpGS.gsap.set(i[a].progressCBarInner[l], {
                scaleY: l < n ? 1 : 0,
        ...
        var e = document.documentMode === t, a = window.chrome;
        ...
        if (i[e].blockSpacing !== t) {
            ...
            for (var r in i[e].blockSpacing = {}, a) if (a.hasOwnProperty(r)) {
                var o = a[r].split(":");
                switch (o[0]) {
                    case"t":
        ...
        prepareCarousel: function (e, i, a) {
            if (void 0 !== e) {
                ...
                o.slidepositions = void 0 === o.slidepositions ? [] : o.slidepositions, o.slideFakePositions = void 0 === o.slideFakePositions ? [] : o.slideFakePositions, i = o.lastdirection = r(i, o.lastdirection), t.setCarouselDefaults(e), void 0 === o.slidepositions[0] && (o.slideAnims = [], t.organiseCarousel(e, "right", !0, !1, !1), o.focused = 0, o.keepFocusedFirst = !0), o.slide_offset = void 0 !== o.slide_offset && jQuery.isNumeric(o.slide_offset) ? o.slide_offset : 0, o.swipeTo = o.slide_offset + s(e), o.swipeToDistance = Math.abs(o.slide_offset) + Math.abs(s(e)), void 0 !== o.swipeTo && jQuery.isNumeric(o.swipeTo) ? void 0 !== a ? t.swipeAnimate({
                    ...
                    direction: i,
                    fix: !0
                }) : t.swipeAnimate({id: e, to: 0, direction: i, speed: 0}), o.carouselInitialised = !0
            }
        }, carouselToEvalPosition: function (e, a, o) {
            var s = t[e].carousel;
            if (s.justify) s.focused = void 0 === s.focused ? 0 : s.focused, s.slidepositions[s.focused] = void 0 === s.slidepositions[s.focused] ? 0 : s.slidepositions[s.focused], s.slide_offset_target = i(e, s.focused); else {
                a = s.lastdirection = r(a, s.lastdirection);
                var n = "center" === s.horizontal_align ? (s.wrapwidth / 2 - s.slide_width / 2 - s.slide_offset) / s.slide_width : (0 - s.slide_offset) / s.slide_width,
                    l = n % t[e].slideamount, d = l - Math.floor(l), c = -1 * (Math.ceil(l) - l),
                    p = -1 * (Math.floor(l) - l), g = d * s.slide_width,
            ...
            var s = t[e].carousel, n = "center" === s.horizontal_align ? 2 : 1, l = Math.ceil(s.maxVisibleItems / n),
            ...
            var i = t[e.id].carousel, r = {from: i.slide_offset, to: e.to}, o = void 0 === e.speed ? .5 : e.speed;
            if (i.distance = void 0 !== e.distance ? e.distance : e.to, void 0 !== i.positionanim && i.positionanim.pause(), e.fix) {
                if (!1 !== i.snap) {
                    var s = i.slide_offset, n = "end" === e.phase ? i.focusedBeforeSwipe : i.focused;
            ...
            if (!0 !== o.carouselDefaultsCalled && (t.callContWidthManager(e), t.setSize(e, void 0, "setCarouselDefaults"), t.updateDimensions(e, "setCarouselDefaults"), o.carouselDefaultsCalled = !0), void 0 === t[e].navOutterOffsets && (t[e].navOutterOffsets = t.getHorizontalOffset(t[e].c, "all")), !0 !== i && (a = t[e].navOutterOffsets.left, r = t[e].navOutterOffsets.right), o.slide_width = !0 !== o.stretch ? t[e].gridwidth[t[e].level] * (0 === t[e].bw ? 1 : t[e].bw) : t[e].conw, o.slide_height = !0 !== o.stretch ? t[e].gridheight[t[e].level] * (0 === t[e].bw ? 1 : t[e].bw) : t[e].conh, o.ratio = o.slide_width / o.slide_height, o.len = t[e].slides.length, o.maxwidth = t[e].slideamount * o.slide_width, 1 != o.justify && o.maxVisiblebackup > o.len && (o.maxVisibleItems = o.len % 2 ? o.len : o.len + 1), o.wrapwidth = o.maxVisibleItems * o.slide_width + (o.maxVisibleItems - 1) * o.space, o.wrapwidth = "auto" != t[e].sliderLayout ? o.wrapwidth > t[e].conw ? t[e].conw : o.wrapwidth : o.wrapwidth > t[e].width ? t[e].width : o.wrapwidth, !0 === o.justify) {
                ...
                for (var s = 0; s < o.len; s++) if (t[e].slides.hasOwnProperty(s)) {
            ...
            if (o.infinity = !(o.wrapwidth >= o.maxwidth) && o.infbackup, !0 !== o.quickmode) {
                ...
                var l = "3D" == t[e].parallax.type || "3d" == t[e].parallax.type ? "visible" : "hidden",
                    d = "right" === o.horizontal_align ? {
                        ...
                        width: o.wrapwidth,
                        overflow: l
                    } : {right: "auto", left: "auto", width: "100%", overflow: l};
                void 0 !== o.cacheWrapObj && d.left === o.cacheWrapObj.left && d.right === o.cacheWrapObj.right && d.width === o.cacheWrapObj.width || (window.requestAnimationFrame(function () {
                    tpGS.gsap.set(o.wrap, d), t[e].carousel.wrapoffset > 0 && tpGS.gsap.set(t[e].canvas, {left: 0})
    ...
    var i = function (e, i) {
        ...
        if (void 0 !== d.positionanim && d.positionanim.pause(), d.justify) "center" === d.horizontal_align ? l = d.windhalf - d.slide_widths[d.focused] / 2 - d.slidepositions[d.focused] : "left" === d.horizontal_align ? l = 0 - d.slidepositions[d.focused] : "right" === d.horizontal_align && (l = d.wrapwidth - d.slide_widths[d.focused] - d.slidepositions[d.focused]), l = l > d.maxwidth / 2 ? d.maxwidth - l : l < 0 - d.maxwidth / 2 ? l + d.maxwidth : l; else {
    ...
    "use strict";
    var t = ["chars", "words", "lines"], i = ["Top", "Right", "Bottom", "Left"],
        a = ["TopLeft", "TopRight", "BottomRight", "BottomLeft"], r = ["top", "right", "bottom", "left"],
        o = jQuery.fn.revolution, s = o.is_mobile();
    o.is_android();
    jQuery.extend(!0, o, {
        checkLayerDimensions: function (e) {
            var t = !1;
            for (var i in o[e.id].layers[e.skey]) if (o[e.id].layers[e.skey].hasOwnProperty(i)) {
                var a = o[e.id].layers[e.skey][i], r = o[e.id]._L[a.id];
            ...
            if ("enterstage" === t) {
                ...
                if (o[e].middleZones && o[e].middleZones.length > 0 && void 0 !== o[e].middleZones[s]) for (r = 0; r < o[e].middleZones[s].length; r++) tpGS.gsap.set(o[e].middleZones[s][r], {y: Math.round(o[e].height / 2 - o[e].middleZones[s][r].offsetHeight / 2) + "px"});
                if (o[e].smiddleZones && o[e].smiddleZones.length > 0) for (r = 0; r < o[e].smiddleZones.length; r++) tpGS.gsap.set(o[e].smiddleZones[r], {y: Math.round(o[e].height / 2 - o[e].smiddleZones[r].offsetHeight / 2) + "px"});
            ...
            for (var n in o[r].layers[e.skey]) if (o[r].layers[e.skey].hasOwnProperty(n)) {
                var l = o[r].layers[e.skey][n], d = jQuery(l), c = o.gA(l, "initialised"),
                ...
                if (void 0 === c) {
                    ...
                    }), void 0 !== p.border) for (t in p.border = p.border.split(";"), p.bordercolor = "transparent", p.border) if (p.border.hasOwnProperty(t)) switch ((i = p.border[t].split(":"))[0]) {
                        case"boc":
                            p.bordercolor = i[1];
                            break;
                        case"bow":
                    ...
                    if ("svg" === p.type && (p.svg = d.find("svg"), p.svgPath = p.svg.find("path"), p.svgI = f(p.svgi, r), p.svgH = f(p.svgh, r)), void 0 !== p.btrans) {
                        ...
                        for (t in p.btrans = {
                            ...
                            rZ: 0,
                            o: 1
                        }, h = h.split(";")) if (h.hasOwnProperty(t)) switch ((i = h[t].split(":"))[0]) {
                            case"rX":
                                p.btrans.rX = i[1];
                                break;
                            case"rY":
                    ...
                    if (void 0 !== p.tsh) for (t in p.tshadow = {
                        ...
                        h: 0,
                        b: 0
                    }, p.tsh = p.tsh.split(";"), p.tsh) if (p.tsh.hasOwnProperty(t)) switch ((i = p.tsh[t].split(":"))[0]) {
                        case"c":
                            p.tshadow.c = i[1];
                            break;
                        case"h":
                    ...
                    if (void 0 !== p.tst) for (t in p.tstroke = {
                        c: "rgba(0,0,0,0.25)",
                        w: 1
                    }, p.tst = p.tst.split(";"), p.tst) if (p.tst.hasOwnProperty(t)) switch ((i = p.tst[t].split(":"))[0]) {
                        case"c":
                            p.tstroke.c = i[1];
                            break;
                        case"w":
                    ...
                    if (void 0 !== p.bsh) for (t in p.bshadow = {
                        ...
                        b: 0,
                        s: 0
                    }, p.bsh = p.bsh.split(";"), p.bsh) if (p.bsh.hasOwnProperty(t)) switch ((i = p.bsh[t].split(":"))[0]) {
                        case"c":
                            p.bshadow.c = i[1];
                            break;
                        case"h":
                    ...
                    if (void 0 !== p.dim) for (t in p.dim = p.dim.split(";"), p.dim) if (p.dim.hasOwnProperty(t)) switch ((i = p.dim[t].split(":"))[0]) {
                        case"w":
                            p.width = i[1];
                            break;
                        case"h":
                    ...
                    if (void 0 !== p.xy) for (t in p.xy = p.xy.split(";"), p.xy) if (p.xy.hasOwnProperty(t)) switch ((i = p.xy[t].split(":"))[0]) {
                        case"x":
                            p.x = i[1].replace("px", "");
                            break;
                        case"y":
                    ...
                    if (!p._isnotext && void 0 !== p.text) for (t in p.text = p.text.split(";"), p.text) if (p.text.hasOwnProperty(t)) switch ((i = p.text[t].split(":"))[0]) {
                        case"w":
                            p.whitespace = i[1];
                            break;
                        case"td":
                    ...
                    if ("column" === p.type && void 0 !== p.textDecoration && delete p.textDecoration, void 0 !== p.flcr) for (t in p.flcr = p.flcr.split(";"), p.flcr) if (p.flcr.hasOwnProperty(t)) switch ((i = p.flcr[t].split(":"))[0]) {
                        case"c":
                            p.clear = i[1];
                            break;
                        case"f":
                    ...
                    if (void 0 !== p.padding) for (t in p.padding = p.padding.split(";"), p.padding) if (p.padding.hasOwnProperty(t)) switch ((i = p.padding[t].split(":"))[0]) {
                        case"t":
                            p.paddingtop = i[1];
                            break;
                        case"b":
                    ...
                    if (void 0 !== p.margin) for (t in p.margin = p.margin.split(";"), p.margin) if (p.margin.hasOwnProperty(t)) switch ((i = p.margin[t].split(":"))[0]) {
                        case"t":
                            p.margintop = i[1];
                            break;
                        case"b":
                    ...
                    if (void 0 !== p.spike && (p.spike = C(p.spike)), void 0 !== p.corners) for (t in a = p.corners.split(";"), p.corners = {}, a) a.hasOwnProperty(t) && a[t].length > 0 && (p.corners[a[t]] = jQuery("<" + a[t] + "></" + a[t] + ">"), p.c.append(p.corners[a[t]]));
                ...
                var m = "grid" === p.basealign ? o[r].width : "carousel" !== o[r].sliderType || p._isstatic ? o[r].width : o[r].carousel.slide_width,
                    ...
                    b = p.x[o[r].level], _ = p.y[o[r].level];
                if (u = "slide" === p.basealign ? 0 : Math.max(0, "fullscreen" == o[r].sliderLayout ? y / 2 - o.iHE(r) * (o[r].keepBPHeight ? 1 : o[r].bh) / 2 : o[r].autoHeight || null != o[r].minHeight && o[r].minHeight > 0 ? o[r].conh / 2 - o.iHE(r) * o[r].bh / 2 : u), g = "slide" === p.basealign ? 0 : Math.max(0, g), "slide" !== p.basealign && "carousel" === o[r].sliderType && p._isstatic && void 0 !== o[r].carousel && void 0 !== o[r].carousel.horizontal_align && (g = Math.max(0, "center" === o[r].carousel.horizontal_align ? 0 + (o[r].width - o.iWA(r, "static") * o[r].bw) / 2 : "right" === o[r].carousel.horizontal_align ? o[r].width - o[r].gridwidth[o[r].level] * o[r].bw : g)), "updateposition" !== e.mode) {
                    if (0 == p.vbility[o[r].levelForced] || "f" == p.vbility[o[r].levelForced] || m < o[r].hideLayerAtLimit && "on" == p.layeronlimit || m < o[r].hideAllLayerAtLimit ? (!0 !== p.layerIsHidden && p.p[0].classList.add("rs-layer-hidden"), p.layerIsHidden = !0) : (p.layerIsHidden && p.p[0].classList.remove("rs-layer-hidden"), p.layerIsHidden = !1), p.poster = null == p.poster && void 0 !== p.thumbimage ? p.thumbimage : p.poster, "image" === p.layertype) if (p.imgOBJ = {}, "cover-proportional" === p.img.data("c")) {
                        ...
                        var w = o.gA(p.img[0], "owidth") / o.gA(p.img[0], "oheight"), x = m / y;
                        ...
                        var L = p.width[o[r].level], T = p.height[o[r].level];
                        if (L = "auto" === L ? L : !jQuery.isNumeric(L) && L.indexOf("%") > 0 ? p._incolumn || p._ingroup ? "100%" : "grid" === p.basealign ? o.iWA(r, e.slideIndex) * o[r].bw : m : "off" !== p.rsp_bd ? parseFloat(L) * o[r].bw + "px" : parseFloat(L) + "px", T = "auto" === T ? T : !jQuery.isNumeric(T) && T.indexOf("%") > 0 ? "grid" === p.basealign ? o.iHE(r) * o[r].bw : y : "off" !== p.rsp_bd ? parseFloat(T) * o[r].bh + "px" : parseFloat(T) + "px", p.vd = void 0 === p.vd ? o[r].videos[d[0].id].ratio.split(":").length > 1 ? o[r].videos[d[0].id].ratio.split(":")[0] / o[r].videos[d[0].id].ratio.split(":")[1] : 1 : p.vd, !p._incolumn || "100%" !== L && "auto" !== T || void 0 === p.ytid) -1 != d[0].className.indexOf("rs-fsv") || S ? (g = 0, u = 0, p.x = o.revToResp(0, o[r].rle, 0), p.y = o.revToResp(0, o[r].rle, 0), p.vidOBJ = {
                            ...
                            height: T,
                            display: "block"
                        }), p._ingroup && null !== p.vidOBJ.width && void 0 !== p.vidOBJ.width && !jQuery.isNumeric(p.vidOBJ.width) && p.vidOBJ.width.indexOf("%") > 0 && (p.OBJUPD.lppmOBJ = {minWidth: L}); else {
                            var A = d.width(), R = "auto" === T ? A / p.vd : T;
            ...
            var i = 0, a = o[t].realslideamount + 1;
            ...
            void 0 !== i && o[t].layers[i] && o.initLayer({
                ...
                }, 150) : o.updateRowZones(o[t].lastAnimateLayersCall), o[t].doubleDimensionCheck = !0, o[t].dimensionReCheck[i] = !0) : o.updateRowZones(o[t].lastAnimateLayersCall), void 0 !== i && o[t].layers[i]) for (var a in o[t].layers[i]) o[t].layers[i].hasOwnProperty(a) && o.renderLayerAnimation({
            ...
            void 0 !== e && o.initLayer({id: e.id, skey: e.key, slideIndex: e.slide, mode: "updateposition"})
            ...
            var i, a = e.layer, r = e.id, s = o[r].level, h = o[r]._L[a[0].id],
                m = void 0 !== h.timeline ? h.timeline.time() : void 0, f = !1, v = !1, _ = "none";
            if (("containerResized_2" !== e.caller && "swapSlideProgress_2" !== e.caller || !0 === h.animationRendered) && (h.animationRendered = !0, "preset" !== e.mode || !0 === h.frames.frame_1.timeline.waitoncall || void 0 !== h.scrollBasedOffset)) {
                if ("trigger" == e.mode && (h.triggeredFrame = e.frame), h._isstatic) {
                    var x = "carousel" === o[r].sliderType && void 0 !== o[r].carousel.oldfocused ? o[r].carousel.oldfocused : void 0 === o[r].pr_lastshown_key ? 1 : parseInt(o[r].pr_lastshown_key, 0) + 1,
                        ...
                        S = x >= h.startslide && x <= h.endslide, L = k >= h.startslide && k <= h.endslide;
                    if (_ = x === h.endslide && "continue" === e.mode || ("continue" === e.mode || x === h.endslide) && "none", !0 === e.allforce || !0 === _) ; else {
                ...
                for (var T in "start" === e.mode && (void 0 !== h.layerLoop && (h.layerLoop.count = 0), e.frame = void 0 === h.triggeredFrame ? 0 : h.triggeredFrame), "continue" !== e.mode && "trigger" !== e.mode && void 0 !== h.timeline && h.timeline.pause(0), "continue" !== e.mode && "trigger" !== e.mode || void 0 === h.timeline || h.timeline.pause(), h.timeline = tpGS.gsap.timeline({paused: !0}), "text" !== h.type && "button" !== h.type || void 0 !== h.splitText && (void 0 !== h.splitTextFix || "start" !== e.mode && "preset" !== e.mode) || (y({
                    layer: a,
                    id: r
                }), "start" === e.mode && (h.splitTextFix = !0)), h.ford) if (h.ford.hasOwnProperty(T)) {
                    var O = h.ford[T], A = !1;
                    if ("frame_0" !== O && "frame_hover" !== O && "loop" !== O) {
                        ...
                        if ("frame_999" !== O || !1 !== _ || "continue" !== e.mode && "start" !== e.mode && "rebuild" !== e.mode) {
                            ...
                            var R = h.frames[O], I = h.fff ? h.frames.frame_0 : void 0, z = tpGS.gsap.timeline(),
                                C = tpGS.gsap.timeline(), P = h.c,
                                B = void 0 !== R.sfx && b(R.sfx.effect, h.m, R.timeline.ease),
                                G = R.timeline.speed / 1e3, M = 0, D = w({
                                    id: r,
                                    frame: R,
                                    layer: a,
                                    ...
                                    splitAmount: P.length,
                                    target: "frame_0"
                                }) : void 0, j = void 0 !== R.mask ? w({
                                    id: r,
                                    frame: {transform: {x: R.mask.x, y: R.mask.y}},
                                    layer: a,
                                    ease: D.ease,
                                    target: "mask"
                                }) : void 0, W = void 0 !== j && h.fff ? w({
                                    id: r,
                            ...
                            if (D.force3D = !0, "block" === B.type && (B.ft[0].background = R.sfx.fxc, B.ft[0].visibility = "visible", B.ft[1].visibility = "visible", z.add(tpGS.gsap.fromTo(B.bmask_in, G / 2, B.ft[0], B.ft[1], 0)), z.add(tpGS.gsap.fromTo(B.bmask_in, G / 2, B.ft[1], B.t, G / 2)), "frame_0" !== O && "frame_1" !== O || (H.opacity = 0)), void 0 !== R.color ? D.color = R.color : void 0 !== h.color && "npc" !== h.color[s] && (D.color = h.color[s]), void 0 !== I && void 0 !== I.color ? H.color = I.color : void 0 !== I && void 0 !== h.color && "npc" !== h.color[s] && (H.color = h.color[s]), void 0 !== R.bgcolor ? R.bgcolor.indexOf("gradient") >= 0 ? D.background = R.bgcolor : D.backgroundColor = R.bgcolor : !0 === h.bgcolinuse && (h.bgcol.indexOf("gradient") >= 0 ? D.background = h.bgcol : D.backgroundColor = h.bgcol), void 0 !== I && (void 0 !== I.bgcolor ? I.bgcolor.indexOf("gradient") >= 0 ? H.background = I.bgcolor : H.backgroundColor = I.bgcolor : !0 === h.bgcolinuse && (h.bgcol.indexOf("gradient") >= 0 ? H.background = h.bgcol : H.backgroundColor = h.bgcol)), void 0 !== h.splitText && !1 !== h.splitText) for (var F in t) if (void 0 !== R[t[F]] && !h.quickRendering) {
                                ...
                                var X = jQuery.extend(!0, {}, Q), J = h.fff ? jQuery.extend(!0, {}, V) : void 0,
                                    q = R[t[F]].dir;
                                delete X.dir, X.data = {splitted: !0}, X.stagger = "center" === q || "edge" === q ? d({
                                    each: Y,
                                    offset: Y / 2,
                                    from: q
                                }) : {
                            ...
                            h.timeline.addLabel(O, U), h.timeline.add(z, U), h.timeline.addLabel(O + "_end", "+=0.01"), z.eventCallback("onStart", c, [{
                                ...
                                frame: O,
                                L: a
                            }]), z.eventCallback("onComplete", g, [{id: r, frame: O, L: a, tPE: i}])
                        }
                    }
                }
                if (void 0 !== h.frames.loop) {
                    ...
                    var ie = h.frames.loop.frame_0, ae = h.frames.loop.frame_999,
                    ...
                    if (h.loop.root.add(h.loop.preset, 0), h.loop.root.add(h.loop.move, ee), h.loop.root.add(h.loop.rotate, ee), h.loop.root.add(h.loop.scale, ee), h.loop.root.add(h.loop.filter, ee), "blur(0px) grayscale(0%) brightness(100%)" === re && "blur(0px) grayscale(0%) brightness(100%)" === oe && (re = "none", oe = "none"), ae.originX = ie.originX, ae.originY = ie.originY, ae.originZ = ie.originZ, void 0 === i && (i = "isometric" === o[r].perspectiveType ? 0 : "local" === o[r].perspectiveType && void 0 !== D ? void 0 !== D.transformPerspective ? D.transformPerspective : h.fff && void 0 !== H.transfromPerspective ? H.transfromPerspective : o[r].perspective : o[r].perspective), h.frames.loop.timeline.curved) {
                        var se = parseInt(h.frames.loop.timeline.radiusAngle, 0) || 0,
                            ne = [{x: (ie.x - ie.xr) * o[r].bw, y: 0, z: (ie.z - ie.zr) * o[r].bw}, {
                                x: 0,
                                y: (ie.y + ie.yr) * o[r].bw,
                                z: 0
                            }, {x: (ae.x + ae.xr) * o[r].bw, y: 0, z: (ae.z + ae.zr) * o[r].bw}, {
                                x: 0,
                                y: (ae.y - ae.yr) * o[r].bw,
                                z: 0
                            }], le = {
                ...
                if (A || (h.lastRequestedMainFrame = "start" === e.mode ? "frame_1" : "continue" === e.mode ? void 0 === e.frame ? h.currentframe : e.frame : h.lastRequestedMainFrame), void 0 !== e.totime ? h.tSTART = e.totime : void 0 !== m && void 0 === e.frame ? h.tSTART = m : void 0 !== e.frame ? h.tSTART = e.frame : h.tSTART = 0, 0 === h.tSTART && void 0 === h.startedAnimOnce && void 0 === h.leftstage && void 0 === h.startedAnimOnce && !0 === h.hideonfirststart && "preset" === e.mode && (o[r]._L[a[0].id].pVisRequest = 0, h.hideonfirststart = !1), "frame_999" !== h.tSTART && "frame_999" !== h.triggeredFrame || !h.leftstage && void 0 !== h.startedAnimOnce) {
                    if ("true" != h.animationonscroll && 1 != h.animationonscroll ? h.timeline.play(h.tSTART) : h.timeline.time(h.tSTART), jQuery.inArray(h.type, ["group", "row", "column"]) >= 0 && void 0 !== e.frame) {
                        if (void 0 === h.childrenJS) for (var F in h.childrenJS = {}, o[r]._L) void 0 !== o[r]._L[F]._lig && void 0 !== o[r]._L[F]._lig[0] && o[r]._L[F]._lig[0].id === a[0].id && o[r]._L[F]._lig[0].id !== o[r]._L[F].c[0].id && (h.childrenJS[o[r]._L[F].c[0].id] = o[r]._L[F].c);
                        ...
                        if (!0 === e.updateChildren) for (var F in h.childrenJS) h.childrenJS.hasOwnProperty(F) && o.renderLayerAnimation({
                            ...
                            updateChildren: !0,
                            totime: ge
                        }); else for (var F in h.childrenJS) h.childrenJS.hasOwnProperty(F) && o[r]._L[F].pausedTrueParrent && (o.renderLayerAnimation({
                            layer: h.childrenJS[F],
                            fastforward: !1,
                            id: r,
                            mode: "continue",
    ...
    var n = function (e) {
        ...
        var t = o[e.id]._L[e.L[0].id], i = t.hovertimeline;
        ...
        if ("column" === o[e.id]._L[e.L[0].id].type || "row" === o[e.id]._L[e.L[0].id].type || "group" === o[e.id]._L[e.L[0].id].type) {
            var i = o[e.id]._L[e.L[0].id].timeline.currentLabel(), a = jQuery.inArray(i, o[e.id]._L[e.L[0].id].ford);
        ...
        var t = o[e.id]._L[e.layer[0].id], i = !1;
        if (t.splitText && !1 !== t.splitText && t.splitText.revert(), "text" === t.type || "button" === t.type) {
            for (var a in t.frames) if (void 0 !== t.frames[a].chars || void 0 !== t.frames[a].words || void 0 !== t.frames[a].lines) {
                i = !0;
                break
            }
        ...
        for (var l in a) if (a.hasOwnProperty(l)) {
            if (a[l] = "object" == typeof a[l] ? a[l][o[e.id].level] : a[l], "inherit" === a[l] || "delay" === l || "direction" === l || "use" === l) delete a[l]; else if ("originX" === l || "originY" === l || "originZ" === l) r[l] = a[l], delete a[l]; else if (jQuery.isNumeric(a[l], 0)) a[l] = _(a[l], e.frame.reverse, e.target, l, e.id, e.id); else if ("r" === a[l][0] && "a" === a[l][1] && "(" === a[l][3]) a[l] = a[l].replace("ran", "random"); else if (a[l].indexOf("cyc(") >= 0) {
                var d = a[l].replace("cyc(", "").replace(")", "").replace("[", "").replace("]", "").split("|");
                a[l] = new function (e) {
                    return tpGS.gsap.utils.wrap(d, void 0)
                }
            } else if (a[l].indexOf("%") >= 0 && jQuery.isNumeric(t = parseInt(a[l], 0))) a[l] = "x" === l ? _((i.eow || 0) * t / 100, e.frame.reverse, e.target, l, e.id) : "y" === l ? _((i.eoh || 0) * t / 100, e.frame.reverse, e.target, l, e.id) : a[l]; else switch (a[l] = a[l].replace("[", "").replace("]", ""), a[l] = _(a[l], e.frame.reverse, e.target, l, e.id, e.id), a[l]) {
                case"t":
                case"top":
        ...
        if (a.transformOrigin = r.originX + " " + r.originY + " " + r.originZ, !o[e.id].BUG_ie_clipPath && void 0 !== a.clip && void 0 !== i.clipPath && i.clipPath.use) {
            var c = "rectangle" == i.clipPath.type, p = parseInt(a.clip, 0), g = 100 - parseInt(a.clipB, 0),
                u = Math.round(p / 2);
        ...
        var s, n, l = {}, d = {}, c = {};
        for (var p in a = void 0 === a ? "transform" : a, "loop" === r ? (c.autoRotate = !1, c.yoyo_filter = !1, c.yoyo_rotate = !1, c.yoyo_move = !1, c.yoyo_scale = !1, c.curved = !1, c.curviness = 2, c.ease = "none", c.speed = 1e3, c.st = 0, l.x = 0, l.y = 0, l.z = 0, l.xr = 0, l.yr = 0, l.zr = 0, l.scaleX = 1, l.scaleY = 1, l.originX = "50%", l.originY = "50%", l.originZ = "0", l.rotationX = "0deg", l.rotationY = "0deg", l.rotationZ = "0deg") : (c.speed = 300, i ? c.ease = "default" : l.ease = "default"), "sfx" === r && (l.fxc = "#ffffff"), e = e.split(";")) if (e.hasOwnProperty(p)) {
            var g = e[p].split(":");
            switch (g[0]) {
                case"u":
        ...
        var i, a = {}, r = ["transform", "words", "chars", "lines", "mask"],
            s = "global" == o[t].perspectiveType ? o[t].perspective : 0, n = !0;
        for (var l in e) "loop" !== l && "frame_hover" !== l && (a = jQuery.extend(!0, a, e[l]));
        for (var l in e) if (e.hasOwnProperty(l) && (void 0 !== e[l].timeline && (e[l].timeline.usePerspective = !1), "loop" !== l && "frame_hover" !== l)) {
            ...
            for (var d = 1; d <= 4; d++) for (i in a[r[d]]) a[r[d]].hasOwnProperty(i) && (e[l][r[d]] = void 0 === e[l][r[d]] ? {} : e[l][r[d]], a[r[d]][i] = void 0 === e[l][r[d]][i] ? "frame_0" === l ? window.rdF0[r[d]][i] : "frame_1" === l ? window.rdF1[r[d]][i] : a[r[d]][i] : e[l][r[d]][i], e[l][r[d]][i] = void 0 === e[l][r[d]][i] ? a[r[d]][i] : e[l][r[d]][i]);
        ...
        if (void 0 !== e.frame_0.timeline && e.frame_0.timeline.usePerspective && (e.frame_0.transform.transformPerspective = "local" === o[t].perspectiveType ? void 0 === e.frame_0.transform.transformPerspective ? s : e.frame_0.transform.transformPerspective : "isometric" === o[t].perspectiveType ? 0 : o[t].perspective), n) for (var l in e) {
        ...
        var l = window.getComputedStyle(e[0], null),
            ...
            g = p ? void 0 !== c[0].id && void 0 !== o[s]._L[c[0].id] ? o[s]._L[c[0].id] : c.data() : void 0, u = 0;
        ...
        if (A(d.borderStyle, "none")) for (delete d.borderStyle, n = 0; n < 4; n++) delete d["border" + i[n] + "Width"], delete d["border" + i[n] + "Color"]
    }, A = function (e, t) {
        ...
        var t, s, n, l, d, c, p, g, u, h, m = e.a, f = e.b, v = e.c, y = e.d, b = e.e, _ = {}, w = {},
            x = o[f]._L[m[0].id], k = m[0].className;
        ...
        var T = jQuery.extend(!0, {}, x.OBJUPD.POBJ), O = jQuery.extend(!0, {}, x.OBJUPD.LPOBJ);
    ...
    jQuery.extend(!0, t, {
        hideUnHideNav: function (e) {
            ...
            if (void 0 !== t[e] && t[e].navigation.use && (t[e].navigation && t[e].navigation.bullets.enable || t[e].navigation && t[e].navigation.tabs.enable || t[e].navigation && t[e].navigation.thumbnails.enable)) {
                var a = (t.winW - 480) / 500, r = tpGS.gsap.timeline(), s = t[e].navigation.tabs,
            ...
            if (t[e].navigation.use) {
                ...
                var a = t[e].navOutterOffsets.left, o = t[e].navOutterOffsets.right;
            ...
            if (void 0 !== t[e].pr_next_key || void 0 !== t[e].pr_active_key) {
                var n = void 0 === t[e].pr_next_key ? void 0 === t[e].pr_cache_pr_next_key ? t[e].pr_active_key : t[e].pr_cache_pr_next_key : t[e].pr_next_key,
                    l = t.gA(t[e].slides[n], "key"), d = 0, c = !1;
            ...
            var r = t[e].navigation.arrows, o = t[e].navigation.bullets, l = t[e].navigation.thumbnails,
                h = t[e].navigation.tabs, f = p(r), y = p(o), b = p(l), k = p(h);
            for (var S in s(e), n(e), f && (v(r, e), r.c = t[e].cpar.find(".tparrows")), t[e].slides) if (t[e].slides.hasOwnProperty(S) && "true" != t.gA(t[e].slides[S], "not_in_nav")) {
                var L = jQuery(t[e].slides[t[e].slides.length - 1 - S]), T = jQuery(t[e].slides[S]);
    ...
    var r = function (e, i) {
        if (void 0 !== e && null != e.mask) {
            ...
            var s = r / a, n = "vertical" === e.direction ? e.mask.height() : e.mask.width(), l = 0 - o * a,
                ...
                c = l < 0 - (d - n) ? 0 - (d - n) : l, p = t.gA(e.wrap[0], "offset");
        ...
        var l = r.parent().find(".tp-" + n + "s"), d = l.find(".tp-" + n + "s-inner-wrapper"),
            c = l.find(".tp-" + n + "-mask"), p = o.width * i < o.min_width ? o.min_width : Math.round(o.width * i),
            g = Math.round(p / o.width * o.height), u = "vertical" === o.direction ? p : p * s + o.space * (s - 1),
            ...
            t[e].c.on("mousewheel DOMMouseScroll", function (r) {
                var o, s, n, l, d,
                    c = (o = r.originalEvent, s = 0, n = 0, l = 0, d = 0, "detail" in o && (n = o.detail), "wheelDelta" in o && (n = -o.wheelDelta / 120), "wheelDeltaY" in o && (n = -o.wheelDeltaY / 120), "wheelDeltaX" in o && (s = -o.wheelDeltaX / 120), "axis" in o && o.axis === o.HORIZONTAL_AXIS && (s = n, n = 0), l = 1 * s, d = 1 * n, "deltaY" in o && (d = o.deltaY), "deltaX" in o && (l = o.deltaX), (l || d) && o.deltaMode && (o.deltaMode, l *= 1, d *= 1), l && !s && (s = l < 1 ? -1 : 1), d && !n && (n = d < 1 ? -1 : 1), ((d = navigator.userAgent.match(/mozilla/i) ? 10 * d : d) > 300 || d < -300) && (d /= 10), {
                        ...
                        pixelX: l,
                        pixelY: d
                    }), p = !0, g = 0 == t[e].pr_active_key || 0 == t[e].pr_processing_key,
                ...
                if ("carousel" === t[e].sliderType && !1 === t[e].carousel.snap) p = !1, t.swipeAnimate({
                    ...
                    var m = t[e].c.offset().top - jQuery("body").scrollTop(), f = m + t[e].c.height();
        ...
        var a = t[e].carousel, r = t.is_android();
        jQuery(".bullet, .bullets, .tp-bullets, .tparrows").addClass("noSwipe"), t[e].navigation.touch = void 0 === t[e].navigation.touch ? {} : t[e].navigation.touch, t[e].navigation.touch.swipe_direction = void 0 === t[e].navigation.touch.swipe_direction ? "horizontal" : t[e].navigation.touch.swipe_direction, jQuery(".rs-nav-element").rsswipe({
            ...
            swipeStatus: function (i, o, s, n, d, c, p) {
                ...
                var u = l("RS-THUMB", i), m = l("RS-TAB", i);
                ...
                var f = "start" === o ? 0 : r ? p[0].end.x - p[0].start.x : i.pageX - a.screenX,
                    ...
                    y = u ? ".tp-thumbs" : ".tp-tabs", b = u ? ".tp-thumb-mask" : ".tp-tab-mask",
                    _ = u ? ".tp-thumbs-inner-wrapper" : ".tp-tabs-inner-wrapper", w = u ? ".tp-thumb" : ".tp-tab",
                    x = u ? t[e].navigation.thumbnails : t[e].navigation.tabs, k = t[e].cpar.find(b), S = k.find(_),
                    L = x.direction, T = "vertical" === L ? S.height() : S.width(),
                    O = "vertical" === L ? k.height() : k.width(),
                    A = "vertical" === L ? k.find(w).first().outerHeight(!0) + x.space : k.find(w).first().outerWidth(!0) + x.space,
                    R = void 0 === S.data("offset") ? 0 : parseInt(S.data("offset"), 0), I = 0;
                switch (o) {
                    case"start":
        ...
        if (null != e && void 0 !== e.c) {
            var a = "fullwidth" == t[i].sliderLayout || "fullscreen" == t[i].sliderLayout,
                r = a ? t[i].conw : t[i].topc.width(), o = e.c.outerWidth(!0), s = e.c.outerHeight(!0);
            if (!(o <= 0 || s <= 0) && (y(e.c, e, i, s), b(e.c, e, i, o), "outer-left" === e.position && a ? tpGS.gsap.set(e.c, {
                ...
                var n = parseInt(e.padding_top || 0, 0), l = parseInt(e.padding_bottom || 0, 0), d = {}, c = {};
        ...
        var l = i.c.find(".tp-bullet").length, d = n.outerWidth(), c = n.outerHeight(),
            p = d + parseInt(void 0 === i.space ? 0 : i.space, 0),
            g = c + parseInt(void 0 === i.space ? 0 : i.space, 0);
        "vertical" === i.direction ? (n.css({top: (l - 1) * g + "px", left: "0px"}), i.c.css({
            height: (l - 1) * g + c,
            width: d
        })) : (n.css({left: (l - 1) * p + "px", top: "0px"}), i.c.css({
            width: (l - 1) * p + d,
            height: c
        })), n.click(function () {
        ...
        var g = a.data("key"), u = i.c.find(n), h = u.find(l), m = i.tmp;
        ...
        var v = i.c.find(d).length, y = f.outerWidth(), b = f.outerHeight(),
            _ = y + parseInt(void 0 === i.space ? 0 : i.space, 0),
            w = b + parseInt(void 0 === i.space ? 0 : i.space, 0);
        "vertical" === i.direction ? (f.css({top: (v - 1) * w + "px", left: "0px"}), h.css({
            height: (v - 1) * w + b,
            width: y
        })) : (f.css({left: (v - 1) * _ + "px", top: "0px"}), h.css({
            width: (v - 1) * _ + y,
            height: b
        })), u.css({maxWidth: i.maxw + "px", maxHeight: i.maxh + "px"}), i.c.css({
            maxWidth: i.maxw + "px",
            maxHeight: i.maxh + "px"
        }), f.click(function () {
        ...
        var i = t[e].cpar.find(".outer-top"), a = t[e].cpar.find(".outer-bottom"), r = t[e].top_outer,
            o = t[e].bottom_outer;
    ...
    jQuery.extend(!0, t, {
        preparePanZoom: function (e) {
            ...
            var s = e.data(), n = e.find("rs-sbg"), l = n.data("lazyload") || n.data("src"),
            ...
            if (t[i].panzoomTLs = void 0 === t[i].panzoomTLs ? {} : t[i].panzoomTLs, t[i].panzoomBGs = void 0 === t[i].panzoomBGs ? {} : t[i].panzoomBGs, void 0 === t[i].panzoomBGs[r] && (t[i].panzoomBGs[r] = e), void 0 !== s.panzoom && null !== s.panzoom) {
                ...
                var u = e.data("pzimg"), h = u.parent(), m = function (e, t, i) {
                    ...
                    var d = l.start.r - l.start.l, c = l.start.b - l.start.t, p = l.end.r - l.end.l,
                        u = l.end.b - l.end.t;
        ...
        checkForParallax: function (e) {
            ...
            if (!r.done) {
                ...
                r.pcontainers = [], r.pcontainer_depths = [], r.bgcontainers = [], r.bgcontainer_depths = [], r.speed = void 0 === r.speed ? 0 : parseInt(r.speed, 0), r.speedbg = void 0 === r.speedbg ? 0 : parseInt(r.speedbg, 0), r.speedls = void 0 === r.speedls ? 0 : parseInt(r.speedls, 0), t[e].c.find("rs-slide rs-sbg-wrap, rs-slide rs-bgvideo").each(function () {
                    var i = jQuery(this), a = i.data("parallax");
                ...
                if ("mouse" == r.type || "mousescroll" == r.type || "3D" == r.type || "3d" == r.type) {
                    ...
                    "carousel" === t[e].sliderType && (n = "rs-slide .dddwrapper, rs-slide .dddwrapper-layer, rs-static-layers .dddwrapper-layer"), r.sctors = t[e].c.find(n), r.mouseEntered = !1, t[e].c.mouseenter(function (i) {
                        var a = t[e].c.offset().top, o = t[e].c.offset().left;
            ...
            var a, r, o = i.eventData, s = t[e].c.offset().left, n = t[e].c.offset().top, l = t[e].conw, d = t[e].conh,
                c = i.speed / 1e3 || 3;
            ...
            for (var f = 0; f < i.pcontainers.length; f++) {
                var v = i.pcontainers[f], y = i.pcontainer_depths[f],
                    b = "3D" == i.type || "3d" == i.type ? y / 200 : y / 100, _ = a * b, w = r * b;
                "mousescroll" == i.type ? tpGS.gsap.to(v, c, {
                    force3D: "auto",
                    x: _,
                    ease: "power3.out",
                    overwrite: "all"
                }) : tpGS.gsap.to(v, c, {force3D: "auto", x: _, y: w, ease: "power3.out", overwrite: "all"})
            }
            "3D" != i.type && "3d" != i.type || i.sctors.each(function () {
                var s = jQuery(this),
                    ...
                    l = a * n, d = r * n, p = 0 == t[e].conw ? 0 : Math.round(a / t[e].conw * n * 100) || 0,
                    g = 0 == t[e].conh ? 0 : Math.round(r / t[e].conh * n * 100) || 0, u = s.closest("rs-slide"), h = 0,
                    m = !1;
            ...
            if ("3d" != c.type && "3D" != c.type) {
                if (("scroll" == c.type || "mousescroll" == c.type) && c.pcontainers) for (var p = 0; p < c.pcontainers.length; p++) if (c.pcontainers[p].length > 0) {
                    var g = c.pcontainers[p], u = c.pcontainer_depths[p] / 100,
                ...
                if (c.bgcontainers) for (p = 0; p < c.bgcontainers.length; p++) {
                    var f = c.bgcontainers[p], v = c.bgcontainer_depths[p];
            ...
            if (y.set && (!i || !1 === y.disable_onmobile)) {
                ...
                if (b = b < 0 ? 0 : b, !1 !== y._L) {
                    var _ = 1 - b * y.multiplicator_layers, w = {force3D: "true"};
                ...
                if (!1 !== y.bgs) {
                    ...
                    for (var L in "top" == y.direction && t[e].scrollproc >= 0 && (_ = 1), "bottom" == y.direction && t[e].scrollproc <= 0 && (_ = 1), _ = _ > 1 ? 1 : _ < 0 ? 0 : _, y.bgs) if (y.bgs.hasOwnProperty(L)) {
    ...
    var a = function (e, i) {
        ...
        var r = e.find(".dddwrapper"), o = e.find(".dddwrapper-layer");
        e.find(".dddwrapper-layertobggroup").appendTo(r), "carousel" == t[i].sliderType && (a.ddd_shadow && r.addClass("dddwrappershadow"), tpGS.gsap.set(r, {borderRadius: t[i].carousel.border_radius})), tpGS.gsap.set(e, {
            overflow: "visible",
            transformStyle: "preserve-3d",
            perspective: 1600
        }), tpGS.gsap.set(r, {
    ...
    var i = function (e, t) {
        ...
        var a = e.id,
            ...
            l = !0 === e.recall ? jQuery.extend(!0, {}, t[a].lastSliderTransition) : function (e, i, a) {
                ...
                }), {nTR: u = Math.max(0, Math.min(30, u)), TR: f[m], trC: h}
            ...
            c = !1, p = void 0 !== t[a].pr_next_bg && t[a].pr_next_bg.length > 0 && void 0 !== t[a].pr_next_bg[0],
        ...
        var u = !0 === e.recall ? l.ntrid : e.ntrid || 0, h = i(e.animation.masterspeed, u);
        ...
        var f = 7 === d || 16 === d || 8 === d ? 0 : 1, v = d < 11 || 17 === d || 18 === d ? 0 : 1;
        if (p) {
            ...
            void 0 !== y[0] && t[a].mtl.add(tpGS.gsap.set(y, {
                ...
                y: 0,
                clearProps: "filter, transform"
            }), 0), t[a].mtl.add(tpGS.gsap.set(t[a].pr_next_bg.parent(), {backgroundColor: "transparent"}), 0)
        }
        if (g) {
            ...
            void 0 !== b[0] && t[a].mtl.add(tpGS.gsap.set(b, {
                ...
                y: 0,
                clearProps: "filter, transform"
            }), 0), t[a].mtl.add(tpGS.gsap.set(t[a].pr_active_bg.parent(), {backgroundColor: "transparent"}), 0)
        }
        var _ = i(e.animation.easein, u), w = i(e.animation.easeout, u);
                ...
                t[a].mtl.add(tpGS.gsap.staggerTo(A, 2 * h / 1e3, {
                    ...
                    onUpdate: function () {
                        ...
                        for (var i = 0; i < t[a].slots + 1; i++) {
                            var r = A[i].mt, s = A[i].ml, n = A[i].it, l = A[i].mt - O, d = A[i].ml + T,
                                c = A[i].it - O / 4;
                            o({
                                ctx: x.ctx,
                                poly: [[e - T + s, 0 + r], [e + T + 1 + s, 0 + r], [e + 1 + s, O + r], [e - L + s, O + r]],
                                bg: {
                                ...
                                ctx: x.ctx,
                                poly: [[e - T + d, 0 + l], [e + T + 1 + d, 0 + l], [e + 1 + d, O + l], [e - L + d, O + l]],
                                bg: {
        ...
        if (0 == d) {
            var I = Math.ceil(t[a].height / t[a].sloth), z = 0;
            ...
            var C = tpGS.gsap.timeline(), P = h / 1e3 - h / 1e3 / t[a].slots;
            ...
            t[a].mtl.add(tpGS.gsap.fromTo(this.getElementsByTagName("div"), h / 1e3, {
                ...
                transformPerspective: 600,
                scale: 1.2
            }, {x: 0, y: 0, ease: w, force3D: "auto", scale: 1, filter: "blur(0px)", opacity: 1, rotation: 0}), 0)
        }); else if (9 == d || 10 == d) {
            var B = t[a].pr_next_bg[0].getElementsByClassName("slotslide"), G = h - h / 1.8;
            for (R = 0; R < B.length; R++) t[a].mtl.add(tpGS.gsap.fromTo(B[R], (h - R * (G / t[a].slots)) / 1e3, {
                zIndex: 10,
                opacity: 0
            }, {opacity: 1, ease: "none", delay: R * (G / t[a].slots) / 1e3}), 0)
        } else if (11 == d) {
            l.trC = Math.min(12, l.trC);
            var M = 2 == l.trC ? "#000000" : 3 == l.trC ? "#ffffff" : "transparent";
            switch (h = 0 === h ? 10 : h, l.trC) {
                case 0:
                    p && t[a].mtl.add(tpGS.gsap.fromTo(t[a].pr_next_bg, h / 1e3, {autoAlpha: 0}, {
                        autoAlpha: 1,
                        force3D: "auto",
                        ease: _
                    }), 0);
                ...
                case 1:
                    p && t[a].mtl.add(tpGS.gsap.fromTo(t[a].pr_next_bg, h / 1e3, {autoAlpha: 0}, {
                        ...
                        force3D: "auto",
                        ease: _
                    }), 0), t[a].mtl.add(tpGS.gsap.fromTo(t[a].pr_active_bg, h / 1e3, {autoAlpha: 1}, {
                        autoAlpha: 0,
                        force3D: "auto",
                        ease: _
                    }), 0);
                ...
                case 4:
                    t[a].mtl.add(tpGS.gsap.set(t[a].pr_active_bg.parent(), {
                        ...
                        force3D: "auto",
                        ease: _
                    }), 0), p && t[a].mtl.add(tpGS.gsap.fromTo(t[a].pr_next_bg, h / 2e3, {autoAlpha: 0}, {
                        autoAlpha: 1,
                        force3D: "auto",
                        ease: _
                    }), h / 2e3);
                ...
                case 12:
                    ...
                    p && t[a].mtl.add(tpGS.gsap.fromTo(t[a].pr_next_bg, h / 1e3, {
                        ...
                        filter: H,
                        "-webkit-filter": H
                    }, {autoAlpha: 0, force3D: "auto", ease: _, filter: D, "-webkit-filter": D}), 0)
            }
            ...
            var j = 3 == l.trC ? h / 1300 : h / 1e3, W = h / 1e3, N = 5 == l.trC || 6 == l.trC ? 0 : t[a].width,
                F = 5 == l.trC || 6 == l.trC ? 0 : t[a].currentSlideHeight, E = 12 == d ? N : 15 == d ? 0 - N : 0,
                Q = 13 == d ? 5 == l.trC || 6 == l.trC ? 0 : t[a].height : 14 == d ? 5 == l.trC || 6 == l.trC ? 0 : 0 - t[a].height : 0,
                V = 1 == l.trC || 2 == l.trC || 5 == l.trC || 6 == l.trC ? 0 : 1,
                Y = 4 == l.trC || 5 == l.trC ? .6 : 6 == l.trC ? 1.4 : 1, X = 5 == l.trC ? 1.4 : 6 == l.trC ? .6 : 1;
            if (7 != l.trC && 4 != l.trC || (N = 0, F = 0), 8 == l.trC ? (t[a].mtl.add(tpGS.gsap.set(t[a].pr_active_slide, {zIndex: 20}), 0), t[a].mtl.add(tpGS.gsap.set(t[a].pr_next_slide, {zIndex: 15}), 0), t[a].mtl.add(tpGS.gsap.to(t[a].pr_next_bg, .01, {
                overflow: "hidden",
                x: 0,
                y: 0,
                scale: 1,
                ...
                immediateRender: !0,
                force3D: "auto"
            }), 0)) : (void 0 !== t[a].pr_active_slide && t[a].pr_active_slide.length > 0 && t[a].mtl.add(tpGS.gsap.set(t[a].pr_active_slide, {zIndex: 15}), 0), void 0 !== t[a].pr_next_slide && t[a].pr_next_slide.length > 0 && t[a].mtl.add(tpGS.gsap.set(t[a].pr_next_slide, {zIndex: 20}), 0), p && t[a].mtl.add(tpGS.gsap.fromTo(t[a].pr_next_bg, j, {
                x: E,
                y: Q,
                overflow: "hidden",
                scale: X,
            ...
            t[a].mtl.add(tpGS.gsap.set(t[a].pr_active_slide, {zIndex: 20}), 0), t[a].mtl.add(tpGS.gsap.set(t[a].pr_next_slide, {zIndex: 15}), 0), t[a].pr_active_bg.find(".slotslide").each(function (e) {
                t[a].mtl.add(tpGS.gsap.fromTo(this, h / 1e3, {
                    ...
                    delay: 0,
                    ease: _
                }), 0), t[a].mtl.add(tpGS.gsap.fromTo(this, h / 2e3, {opacity: 1}, {opacity: 0, delay: h / 2e3}), 0)
            }), p && t[a].mtl.add(tpGS.gsap.fromTo(t[a].pr_next_bg, h / 1e3 - h / 7e3, {
                x: 100 * Math.random() - 50,
                opacity: 1,
                scale: .9,
                rotationZ: 10 * Math.random() - 5
            }, {x: 0, opacity: 1, scale: 1, rotationZ: 0, ease: _, force3D: "auto", delay: h / 7e3}), 0)
            ...
            tpGS.gsap.set(t[a].c, {
                ...
                transformPerspective: 1200,
                transformOrigin: J
            }), 0), t[a].mtl.add(tpGS.gsap.fromTo(t[a].pr_next_bg, h / 2e3, {z: 19 == d || 23 === d ? -200 : 0}, {
                z: 19 === d || 23 === d ? 0 : -200,
                ease: "power3.inOut",
                delay: 19 === d || 23 === d ? h / 2e3 : 0
            }), 0)), 22 !== d && 24 !== d || (g && q.push(t[a].pr_active_bg), t[a].mtl.add(tpGS.gsap.fromTo(q, h / 2e3, {z: -200}, {
                z: 0,
                ease: "power2.in",
                delay: h / 2e3
            }), 0)), g && t[a].mtl.add(tpGS.gsap.fromTo(t[a].pr_active_bg, h / 2e3, {z: 0}, {
                z: -200,
                ease: "power3.inOut",
                delay: 0,
                force3D: "auto"
            }), 0), !g || 19 !== d && 23 !== d || t[a].mtl.add(tpGS.gsap.fromTo(t[a].pr_active_bg, h / 2e3, {autoAlpha: 1}, {
                autoAlpha: 0,
                ease: "none",
                delay: h / 2e3,
                force3D: "auto"
            ...
            var Z = 25 === d ? t[a].rotate : 1 === n ? 90 : -90, U = 25 === d ? 1 === n ? -90 : 90 : t[a].rotate;
            ...
            p && t[a].mtl.add(tpGS.gsap.fromTo(t[a].pr_next_bg, h / 1e3, {
                ...
                transformPerspective: 1200,
                force3D: "auto"
            }, {immediateRender: !0, rotationX: U, transformOrigin: J, rotationY: Z, ease: w}), 0)
        } else if (26 == d) h = 0, p && (t[a].mtl.add(tpGS.gsap.fromTo(t[a].pr_next_bg, .001, {autoAlpha: 0}, {
            autoAlpha: 1,
            force3D: "auto",
            ease: _
        }), 0), t[a].mtl.add(tpGS.gsap.set(t[a].pr_next_bg.find("rs-sbg"), {autoAlpha: 1}), 0)), g && (t[a].mtl.add(tpGS.gsap.to(t[a].pr_active_bg, .001, {
            autoAlpha: 0,
            force3D: "auto",
            ease: _
        }), 0), t[a].mtl.add(tpGS.gsap.set(t[a].pr_active_bg.find("rs-sbg"), {autoAlpha: 1}), 0)); else if (27 == d || 28 == d || 29 == d || 30 == d) {
            var K = t[a].pr_next_bg.find(".slot"), $ = 27 == d || 29 == d ? "-100%" : "100%",
                ee = 27 == d || 29 == d ? "100%" : "-100%", te = 27 == d || 29 == d ? "-80%" : "80%",
                ie = 27 == d || 29 == d ? "80%" : "-80%", ae = 27 == d || 29 == d ? "10%" : "-10%",
                re = {overwrite: "all"}, oe = {autoAlpha: 0, zIndex: 1, force3D: "auto", ease: _},
                ...
                ce = {overwrite: "all", zIndex: 2, autoAlpha: 1}, pe = {autoAlpha: 1, force3D: "auto", ease: _},
        ...
        c && m.length > 0 && t[a].mtl.add(tpGS.gsap.set(m, {
            zIndex: 30, display: "block", onComplete: function () {
                t.playVideo(m, a)
            }
        }))
    }, r = function (e, t, i, a, r) {
        ...
        if (0 !== e.length) {
            ...
            var d = void 0 !== o[0] && void 0 !== o[0].dataset && void 0 !== o[0].dataset.lazyload ? o[0].dataset.lazyload : o.attr("src"),
                c = t[i].width, p = t[i].autoHeight ? t[i].c.height() : t[i].height, g = o.data("fxof"), u = 0,
                h = e.data("bgcolor") || "transparent", m = e.data("bgfit") || "cover",
                f = e.data("bgrepeat") || "no-repeat", v = e.data("bgposition") || "center center",
            ...
            if (e.detach(), e.find(".slot").each(function () {
                jQuery(this).remove()
            }), "box" === r) for (var w = 0, x = 0, k = 0; k < t[i].slots; k++) {
                x = 0;
    ...
    jQuery.extend(!0, t, {
        preLoadAudio: function (e, i) {
            ...
            switch (clearTimeout(a.videoplaywait), a.type) {
                case"youtube":
                    if (0 == e.find("iframe").length) e.append(a.videomarkup), u(e, i, !0); else if (null != a.player.playVideo) {
            ...
            for (var r in t[e].videos) {
                ...
                if ((o.bgvideo || o.fcover) && ("html5" === o.type && void 0 !== o.jvideo && tpGS.gsap.set(o.jvideo, {width: i}), void 0 === t[e].activeRSSlide || o.slideid === t.gA(t[e].slides[t[e].activeRSSlide], "key") || void 0 === t[e].pr_next_slide || o.slideid === t.gA(t[e].pr_next_slide[0], "key"))) {
                    ...
                    var s = i / a, n = s / o.vd * 100, l = o.vd / s * 100;
            ...
            if (s.audio = void 0 !== s.audio && s.audio, i && s.opom) 0 == e.find("rs-poster").length && e.append('<rs-poster class="noSwipe" style="background-image:url(' + s.poster + ');"></rs-poster>'); else {
                ...
                if (!(null != s.poster && s.poster.length > 2) || i && s.npom) {
                    ...
                    if (t.playVideo(e, a), i) {
                        ...
                        tpGS.gsap.to(e.find("rs-poster"), .3, {
                            ...
                            force3D: "auto",
                            ease: "power3.inOut"
                        }), tpGS.gsap.to(e.find("iframe"), .3, {opacity: 1, display: "block", ease: "power3.inOut"})
                    }
                });
    ...
    var r = function (e, t, i) {
        ...
        if (n.ifr = e.find("iframe"), s(a, e), n.ifr.attr("id", d), n.startvideonow = r, n.videolistenerexist) {
            ...
            case"vimeo":
                ...
                var x, k = t.is_mobile() || t.isSafari11(), S = "RS-BGVIDEO" === e[0].tagName;
        ...
        n.metaloaded = !0, n.controls && !n.audio || (0 != e.find(".tp-video-play-button").length || i || e.append('<div class="tp-video-play-button"><i class="revicon-right-dir"></i><span class="tp-revstop">&nbsp;</span></div>'), e.find("video, rs-poster, .tp-video-play-button").click(function () {
            ...
            void 0 !== e && void 0 !== e[0] && !0 !== n.VideoIsVisible && !0 !== n.justReseted && (e[0].getElementsByTagName("rs-poster").length > 0 ? (tpGS.gsap.to(e[0].getElementsByTagName("rs-poster"), .3, {
                ...
                n.seeking || (tpGS.gsap.to(e.find("rs-poster"), .001, {
                    ...
                    force3D: "auto",
                    ease: "power3.inOut"
                }), tpGS.gsap.to(e.find(n.tag), 1e-4, {opacity: 0, ease: "power3.inOut"})), n.VideoIsVisible = !1
            ...
            !t.checkfullscreenEnabled(a) && e.find("rs-poster").length > 0 && n.scop && (n.showCoverSoon = setTimeout(function () {
                n.seeking || (tpGS.gsap.to(e.find("rs-poster"), .001, {
                    ...
                    force3D: "auto",
                    ease: "power3.inOut"
                }), tpGS.gsap.to(e.find(n.tag), 1e-4, {opacity: 0, ease: "power3.inOut"}))
